        ...
        a.prototype = {
            ...
            render: function (a) {
                var g = this,
                    ...
                    z = b.dowNames || "Dom Seg Ter Qua Qui Sex Sab".split(" "),
                    t = b.monthNames || "Janeiro Fevereiro Março Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro".split(" "),
                    f = d.outerWidth(),
                ...
                f._add(l);
                e = $("<div/>").addClass(" core border monyear ").css($.extend({}, j, {
                    borderWidth: h + " 0 0 " + h
                ...
                for (l = e = 0; 7 > e; e++)
                    for (var q = 0; 7 > q; q++, l++) {
                        ...
                        if (e) {
                            ...
                            }!s || 0 > v._indexOf(p.year) || 0 > H._indexOf(p.month) || 0 > y._indexOf(p.day) ? n = "noday" : (n = "dom seg ter qua qui sex sab".split(" ")[p.day], I != p.month && (n += " outday"), u == x && (n = "today", r += 50), b.selectedDate._time() == x && (n = "selected", r += 51), b.specialDates && $.each(b.specialDates, function (b, a) {
                                D(a, a.date).time ==
