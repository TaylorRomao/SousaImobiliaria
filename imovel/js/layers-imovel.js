atwpjp([233, 227], {
    ...
    615: function (t, e, n) {
        ...
        function l(t) {
            if (t._e) return !0;
            for (var e in t)
                if ("_e" != e && t.hasOwnProperty(e)) return delete t._e, !1;
            return t._e = 1, !0
        }
        ...
        function f(t, e) {
            if (t = c(t)) {
                if (!t.className) return; - 1 !== t.className.indexOf(e) && (t.className = t.className.split(e).join(" "))
            }
        }
        ...
        function _() {
            ...
            try {
                ...
                var r = n.innerWidth;
                e.removeChild(n), a.removeChild(e), B = i && r ? i - r : 20
            } catch (s) {
                B = 20
            }
            return B
        ...
        if (!window._atw) {
            ...
            window._atw = {
                ...
                clo: function () {
                    var t = c(_atw.did);
                    return t && u(t), _atw.sta && "compact" === _atw.sta && (_ate.ed.fire("addthis.menu.close", window.addthis || {}, {
                        pane: _atw.sta
                    }), _atw.sta = null), !1
                },
                hash: window.location.hash,
                clb: function () {
                    return _atw.mck = 0, _atw.addthis_popup_mode ? window.close() : (u("at16lb"), u("at16p"), u("at15s"), f("at15s_head", "at15s_head_success"), u("at15s"), (_ate.maf || {}).pre && _ate.maf.pre.focus()), _atw.sta && "compact" !== _atw.sta && (_ate.ed.fire("addthis.menu.close", window.addthis || {}, {
                        pane: _atw.sta
                    }), _atw.sta = null), !1
                },
                sho: function (t) {
                    ...
                    if (u(a), u("at_error"), u(n), u(o), u("at_success"), f("at15s_head", "at15s_head_success"), "share" === t || "" === t || "bkmore" === t ? ("bkmore" === t ? (l = d = !0, h(_atw.did, "mmborder")) : (t = "share", o.style.display = "", f(_atw.did, "mmborder")), u(i), _atw.conf.ui_use_vertical_menu && u("at15s_head"), p(n), E.ipa && r("at16lb"), s && (s.innerHTML = addthis_caption_share)) : (_atw.mck++, "more" !== t ? (("bkemail" === t || _atw.ibm()) && (h(_atw.did, "mmborder"), d = !0), _atw.rse(), u(a), s.innerHTML = addthis_caption_email) : (p(a), s && (s.innerHTML = addthis_caption_share)), l = !0), l || d) {
                        ...
                        var g = w(!0),
                            x = w(),
                            y = _();
                        if (v(e, g[0] - y), b(e, g[1] - y), i.style.marginTop = Math.max(0, x[1] / 2 - 222.5) + "px", !m && (p(i), "more" === t)) {
                            v(i, 300);
                            var k = c("at16filt");
                    ...
                    if (_atw.show-- > 0) {
                        var C = _atw.conf.services_compact_org || "",
                            M = C.split(",").length,
                            A = 0,
                            S = 0,
                ...
                menu: function (t, e, a, r) {
                    ...
                    if (_atw.ost) {
                        var v = c("at15s_brand"),
                            b = c("at16_brand"),
                            _ = _atw.conf.ui_cobrand,
                            y = c("at15ptc"),
                            k = _atw.conf.ui_header_color,
                            M = _atw.conf.ui_header_background;
                        v && (v.innerHTML = _), b && (b.innerHTML = _), y && (y.innerHTML = window.addthis_caption_share), d("at15s_head", "backgroundColor", M), d("at16pt", "backgroundColor", M), d("at16ptx", "color", k), d("at16pt", "color", k), d("at16ptc", "color", k), d("at15s_brand", "color", k), d("at16ptc", "color", k), _atw.conf.ui_use_close_control ? (h("at15s_brand", "at15s_brandx"), f("at15sptx", "at15dn")) : (f("at15s_brand", "at15s_brandx"), h("at15sptx", "at15dn"))
                    } else {
                        if (i(_atw.hkd), !_atc.ostm) {
                            if (!window.addthis_product || 0 !== window.addthis_product.indexOf("f"))
                                for (G in window.addthis_conf) window.addthis_conf.hasOwnProperty(G) && (_atc[G] = window.addthis_conf[G]);
                            for (G in window.addthis_config)
                                if (window.addthis_config.hasOwnProperty(G)) {
                        ...
                        var A, z, I, O, N = (_atw.conf.services_exclude || "").replace(/\s/g, "").replace(/\*/, ""),
                            ...
                            H = "";
                        if (N)
                            for (var F = N.split(","), V = 0; V < F.length; V++) U[F[V]] = 1;
                        _atw.excluded = U;
                        var W = (_atw.conf.services_compact || addthis_options_default).replace(/\s/g, "").replace(/\*/, "");
                        "" === S() && -1 == B.indexOf("ffext") && -1 == B.indexOf("fxe") && (W = W.replace(/^email(?:,)|,email/g, "")), W = W.split(",");
                        for (var G = 0; G < W.length; G++)
                            if (G < W.length - 1 && "more" === W[G]) {
                                var Y = W.splice(G, 1);
                                W.push(Y[0]);
                                break
                            }
                        W = o(W);
                        var q = _atw.list,
                            K = _atw.conf.services_expanded || [],
                            Z = 0;
                        if (_atw.conf.services_expanded) K = K.replace(/ /g, "").split(",");
                        else
                            for (var A in q) q.hasOwnProperty(A) && ("string" != typeof A || U[A] || K.push(A));
                        for (K.sort(function (t, e) {
                                if ("string" == typeof q[t] && "string" == typeof q[e]) {
                                    var n = (q[t] || "").toLowerCase(),
                                        a = (q[e] || "").toLowerCase();
                                    return (n > a ? 1 : n == a ? 0 : -1) || 0
                                }
                                return 0
                            }), G = 0; G < K.length; G++) A = K[G], O = _atw.css[A], I = q[A], "string" != typeof I || U[A] || Z++;
                        for (var J, Q, X = n(356)({
                                campaign: "AddThis compact menu"
                            }), $ = n(28).isBrandingReduced(), tt = !E.ipa && _atw.conf.ui_use_vertical_menu, et = p.div(X.generateBranding($)).css(tt ? "atm-f" : "").id("at15pf"), nt = p.div(p.span(addthis_caption_share).id("at15ptc"), p.span(_atw.conf.ui_cobrand).id("at15s_brand").css(_atw.conf.ui_use_close_control ? "at15s_brandx" : ""), p.a("X").id("at15sptx").css(_atw.conf.ui_use_close_control ? "" : "at15dn").href("#").attr("tabindex", "9000").attr("onclick", "return _atw.clb()").attr("onkeydown", "if(!e){var e = window.event||event;}if(e.keyCode){_ate.maf.key=e.keyCode;}else{if(e.which){_ate.maf.key=e.which;}}if(_ate.maf.key==9){ addthis_close(); _ate.maf.sib.tabIndex=9001;_ate.maf.sib.focus();}else{/*alert(_ate.maf.key)*/} _ate.maf.key=null")).id("at15s_head"), at = "ja,fr,he,it,af,ga,el,tl,ro,ru,ms,mk,az,zh,sq,te,be,ta,uk,ml,eu,se,su,aze,gre,tra,fre,gdh,jpn,mac,mak,msa,may,ron,rum,rus,tam,tgl,ukr,zho", ot = (window.addthis_ssh || "").split(","), it = {}, rt = [], G = 0; G < ot.length; G++) it[ot[G]] = 1;
                        ...
                        for (var G = 0; G < W.length; G++) {
                            ...
                            var st = C(),
                                ...
                                ct = it[lt] || it[A];
                            if (A in _atw.list) {
                                if (I = _atw.list[A], U[A] || "string" != typeof I) continue;
                                if (z = O ? D(A, O) : T({
                                        code: A,
                                        alt: I,
                                        title: I
                                    }), !z) continue;
                                ("email" !== A || "" !== S() || B.indexOf("ffext") > -1 || B.indexOf("fxe") > -1) && (tt ? (J = p.a(z, p.span(_atw.list[A] + ("more" === A && -1 === at.indexOf(st) ? " (" + Z + ")" : "")).css("at-label", ct ? " at_bold" : "", "at-size-16")).id("atic_" + A).href("#"), Q = J.element, Q.addEventListener ? (Q.addEventListener("keypress", R, !1), Q.addEventListener("keydown", P, !1), Q.addEventListener("blur", L, !1), Q.addEventListener("click", j.bind(null, A), !1)) : Q.attachEvent && (Q.attachEvent("onkeypress", R), Q.attachEvent("onkeydown", P), Q.attachEvent("onblur", L), Q.attachEvent("onclick", j.bind(null, A)))) : J = p.a(z, p.span(_atw.list[A] + ("more" === A && -1 === at.indexOf(st) ? " (" + Z + ")" : "")).css("at-label")).id("atic_" + A).href("#").css("at_item " + (E.ipa ? "addthis_16x16_style " : "") + (ct ? " at_bold" : "") + " at_col" + G % 2).attr("onclick", "return addthis_sendto('" + A + "');").attr("onmouseover", l.bro.ipa ? "" : "_atw.shv(this)").attr("onmouseout", l.bro.ipa ? "" : "_atw.rhv(this)").attr("tabindex", G + 2), rt.push(J), 0 === G && (_ate.maf.firstCompact = "atic_" + A))
                            }
                        }
                    ...
                    if (vt = "undefined" != typeof (window.addthis_config || {}).ui_offset_top ? (window.addthis_config || {}).ui_offset_top || 0 : _atw.conf.ui_offset_top || 0, "undefined" != typeof (window.addthis_config || {}).ui_offset_left ? offLeft = (window.addthis_config || {}).ui_offset_left || 0 : offLeft = _atw.conf.ui_offset_left || 0, _atw.sho(e, a), "more" !== e && "bkemail" !== e && !m(_atw.did, "mmborder")) {
                        var bt = void 0 != offLeft ? offLeft : _atw.conf.ui_offset_left,
                            wt = void 0 != vt ? vt : _atw.conf.ui_offset_top,
                            xt = 0,
                            _t = 0,
                            yt = w(),
                            kt = x(),
                            ...
                            Mt = Ct.style,
                            At = _atw.conf.ui_hover_direction || 0,
                            Et = _atw.conf.ui_compact_direction || -1,
                            St = "bkmore" == e || m(_atw.did, "mmborder"),
                            zt = -1 != Et && 1 & Et,
                            It = -1 != Et && 2 & Et,
                            Ot = -1 != Et && 4 & Et,
                            Nt = -1 != Et && 8 & Et;
                        ...
                        if (St) {
                            var Dt = c("at16p");
                            xt = yt[0] / 2 - Tt / 2, _t = Dt && "" != Dt.style.marginTop ? Dt.style.marginTop : Math.max(0, yt[1] / 2 - 222.5) + "px", _t = _t.split("px").shift() - 8
                        } else {
                            ...
                            var Bt = Rt.top > .66 * jt,
                                ...
                                Ht = Bt && Ut;
                            if (Ot || 1 === At || Ht) {
                                var Ft = Ct.getBoundingClientRect(),
                                    Vt = Ft.bottom - Ft.top;
                                xt = Lt + Rt.left, _t = Pt + Rt.top - Vt
                            } else xt = Lt + Rt.left, _t = Pt + Rt.bottom;
                            var Wt = xt - kt[0] + Tt + 20 > yt[0];
                            (zt || !It && Wt) && (xt = xt - Tt + (t.clientWidth || 50))
                        }(gt && ((t.parentNode.parentNode.parentNode.parentNode || {}).className || "").indexOf("bar_vertical") > -1 || !gt && ((t.parentNode.parentNode.parentNode || {}).className || "").indexOf("bar_vertical") > -1) && (_t += kt[1] + (gt ? 16 : 0)), f("at15s_head", "at15s_head_success");
                        var Gt = _ate.util.parent(t, ".addthis_bar"),
                            Yt = _ate.util.parent(t, ".addthis_toolbox"),
                            qt = function (t) {
                                return window.getComputedStyle && null != t && t != document ? "fixed" === window.getComputedStyle(t).position : !1
                            };
                        xt += parseInt(bt, 10), _t += parseInt(wt, 10), Mt.left = xt + "px", qt(Yt) || qt(Gt) ? Mt.top = _t + kt[1] + "px" : Mt.top = _t + "px", Mt.visibility = "visible"
                    }
                ...
                evar: function () {
                    try {
                        ...
                        if (_atw.share = _atw.share || window.addthis_share || {}, (_ate.bro.xp || _ate.bro.mob) && delete _atw.list.mailto, e(_atw.conf, "ui_use_vertical_menu", !0), vertical = !E.ipa && _atw.conf.ui_use_vertical_menu, e(window, "addthis_wpl"), e(window, "addthis_caption_email", _atw.lang(O, 3)), e(window, "addthis_caption", _atw.lang(O, 1)), e(window, "addthis_use_addressbook", !1), e(window, "addthis_product", "men-" + _atw.ver), _atw.list.settings = _atw.lang(O, 47) + "...", _atw.list.more = _atw.lang(O, 2), _atw.list.email = _atw.lang(O, 4), _atw.list.favorites = _atw.lang(O, 5), _atw.list.print = _atw.lang(O, 22), e(window, "addthis_popup", !1), e(window, "addthis_popup_mode", !1), e(window, "addthis_url", ""), e(window, "addthis_append_data", !n || "addthis" == n.toLowerCase()), e(window, "addthis_brand", ""), e(window, "addthis_title", ""), e(window, "addthis_content", ""), e(window, "addthis_email_note", _atc.enote ? _atc.enote : ""), e(window, "addthis_email_from", ""), e(window, "addthis_email_to", ""), e(window, "addthis_use_personalization", !0), e(window, "addthis_options_default", I.getPopServices().split(",").slice(0, 11).join(",") + ",more"), e(window, "addthis_options_rank", I.getPopServices()), e(window, "addthis_options", addthis_options_default), e(window, "addthis_exclude", ""), e(window, "addthis_ssh", ""), e(window, "addthis_logo", ""), e(window, "addthis_logo_background", ""), e(window, "addthis_logo_color", ""), e(window, "addthis_header_background", ""), e(window, "addthis_header_color", ""), e(window, "addthis_caption_share", addthis_caption), e(window, "addthis_caption_feed", _atw.lang(O, 14)), e(window, "addthis_share", {}), E.ipa && (addthis_exclude && -1 == addthis_exclude.indexOf("print") && (addthis_exclude += ","), addthis_exclude += "print"), e(_atw.share, "type", "link"), e(_atw.share, "url", addthis_url), e(_atw.share, "title", addthis_title), e(_atw.share, "description", ""), e(_atw.share, "swfurl", ""), e(_atw.share, "modules", {}), e(_atw.share, "screenshot", ""), e(_atw.share, "author", ""), e(_atw.share, "email_template", window.addthis_email_template || ""), e(_atw.share, "email_vars", window.addthis_email_vars ? "string" == typeof addthis_email_vars ? _ate.util.fromKV(addthis_email_vars) : addthis_email_vars : {}), e(_atw.conf, "ui_cobrand", addthis_brand), e(_atw.conf, "ui_disable", !1), e(_atw.conf, "ui_508_compliant", !1), e(_atw.conf, "ui_window_panes", !1), e(_atw.conf, "ui_close_control", !_atw.conf.ui_cobrand && (_atw.conf.ui_click || _atw.ver >= 200)), e(_atw.conf, "ui_click", _atw.conf.ui_window_panes), e(_atw.conf, "ui_email_note", addthis_email_note), e(_atw.conf, "ui_email_from", _ate.cookie.rck("_atfrom") || addthis_email_from || ""), e(_atw.conf, "ui_email_to", addthis_email_to), e(_atw.conf, "ui_hover_direction", 0), e(_atw.conf, "ui_compact_direction", -1), e(_atw.conf, "ui_delay", window.addthis_hover_delay), e(_atw.conf, "ui_header_color", addthis_header_color), e(_atw.conf, "ui_header_background", addthis_header_background), e(_atw.conf, "ui_icons", !0), e(_atw.conf, "ui_use_mailto", !1), e(_atw.conf, "ui_use_addressbook", addthis_use_addressbook || o), e(_atw.conf, "ui_use_close_control", _atw.conf.ui_close_control), e(_atw.conf, "ui_open_windows", !1), e(_atw.conf, "data_ga_tracker", null), e(_atw.conf, "data_ga_property", null), e(_atw.conf, "data_omniture_collector", ""), e(_atw.conf, "pubid", window.addthis_pub), e(_atw.conf, "username", _atw.conf.pubid), e(_atw.conf, "product", addthis_product), e(_atw.conf, "data_track_clickback", addthis_append_data || _atw.conf.data_track_linkback || _ate.track.ctp(_atw.conf.product)), e(_atw.conf, "services_custom", []), e(_atw.conf, "services_localize", O), e(_atw.conf, "services_expanded", ""), e(_atw.conf, "services_compact_org", _atw.conf.services_compact), e(_atw.conf, "services_exclude", addthis_exclude), _atw.conf.services_exclude = _atw.conf.services_exclude.replace(/\s/g, ""), e("_atw.conf, services_exclude_natural", _atw.conf.services_exclude), _atw.conf.parentServices && Object.keys(_atw.conf.parentServices).forEach(function (t) {
                            ...
                            for (_atw.custom_list = _atw.custom_list || {}, i instanceof Array || (i = [i]), t = 0; t < i.length; t++) {
                                var r = i[t];
            ...
            }, _ate.menu = n(619)(), addthis.menu = _ate.menu.open, addthis.menu.close = _ate.menu.close, _ate.ao = function (t, e, n, a, o, i, r) {
    ...
    806: function (t, e, n) {
        var a, o, i = n(795),
            r = n(349);
        a = [n(807), n(818), n(829)], o = function (e, n, a) {
            var o = a;
            t.exports = function (t) {
                window.addthis && (window.addthis.user.ready(function () {
                    window.addthis.user.getPreferredServices(function (a) {
                        (0 === a.length || "" === a[0]) && (a = r.getDefaultBasicServices()), e.preferredServices = a.filter(function (t) {
                            return i(t)
                        }).concat("compact"), addthis.layers = o, t(), n.trigger("addthis.layers.ready", window.addthis, {
                            pco: e.pco
                        }), o.utils = n
                    })
    ...
    807: function (t, e, n) {
        var a, o, i = n(7),
            ...
            P = n(813),
            L = n(351),
            j = n(591).confRequiresFacebookSDK,
            B = n(592),
            U = n(17);
        a = [n(816), n(817), n(818)], o = function (t, e, a) {
            var o = window,
                H = document,
                F = H.body,
                V = o.addthis,
                ...
                Y = {
                    ...
                    desktopEvents: {
                        "addthis.layers.rendered": a.once(function () {
                            ...
                            }), /\.addthis\.com$/.test(location.hostname) && "/dashboard" === location.pathname && n(404)()
                        })
                    },
                    eventInterceptors: {
                        share: {
                            buttonClick: function (t, e) {
                                window.addthis_config && !window.addthis_config.ui_click || -1 === e.className.indexOf("compact") ? Y.commonEventHandlers.share.buttonClick.call(this, t, e) : (a.preventDefaultEvent(t), Y.commonEventHandlers.share.showCompactMenu.call(this, t, e))
                            },
                            showCompactMenu: function (t, e) {
                                G || !window.addthis_config || window.addthis_config.ui_click || Y.commonEventHandlers.share.showCompactMenu.call(this, t, e)
                            }
                        }
                    },
                    commonEventHandlers: {
                        share: {
                            ...
                            buttonKeydown: function (t, e) {
                                ...
                                (n || a) && Y.commonEventHandlers.share.buttonClick.call(this, t, e)
                            },
                            showCompactMenu: function (t, e) {
                                if (!this.menuOpen) {
                                    var n, a = this,
                        ...
                        mobile: {
                            showExpandedMenu: function (t, e, n) {
                                ...
                                o = t.data ? {
                                    ...
                                    media: void 0,
                                    _expandedMenuFollowServices: s
                                }, r(this.options, o, !0), a.preventDefaultEvent(t), A("mob") ? O(H.body, "more", "", "", {
                                    ui_pane: "expanded"
                                }, o, n) : y(null, function () {
                                    O(H.body, "more", "", "", {
                                        ui_pane: "expanded"
                        ...
                        Object.keys(i).forEach(function (s) {
                            ...
                            Object.keys(l).forEach(function (i) {
                                ...
                                if (i = s.basename, "mobile" !== i) {
                                    ...
                                    o && a.isElement(o);
                                    "both" !== t && (t === r ? a.isVisible(e) || a.isVisible(o) || (a.trigger("addthis.layers.responsive." + i + ".show"), n !== H.body && n !== e && (a.removeClass(Y.hideClass, n), a.removeClass(Y.hiddenClass, n)), "closed" !== s.status ? s.show() : (s.requiresData !== !0 || s.requiresData === !0 && s.trendingLinksJson && s.trendingLinksJson.length) && s.show(o)) : (a.isVisible(e) || a.isVisible(o)) && (a.trigger("addthis.layers.responsive." + i + ".hide"), n !== H.body && a.addClass(Y.hideClass, n), a.addClass(Y.hideClass, e), a.addClass(Y.hideClass, o)))
                                }
                            })
                    ...
                    onloadShowLogic: function (t) {
                        var n = t.namespace,
                            ...
                            i = t.element,
                            r = a.mobile(),
                            s = (t.device, t.container),
                            l = t.options,
                            c = l.showAnimation || "show",
                            d = 1e3 * (l.delay || 0),
                            u = (l.hideAfter || !1, t.device),
                            p = (t.openControl, a.phone() ? "mobile" : a.getCurrentDevice(t));
                        t.isWhatsNextMobile === !0 || ((t.rendered === !0 || t.showOnLoad === !1 || "both" !== u && u !== p || "mobile" === o && !r) && l.showImmediately !== !0 ? (a.addClass("addthis-animated", i), a.addClass(c, i), a.addClass(Y.showClass, i), a.addClass(Y.hideClass, i), a.removeClass(Y.hiddenClass, i)) : a.isElement(i) && ("closed" !== t.status || l.showImmediately === !0 ? a.requestTimeout(function (e) {
                            a.addClass(Y.hideClass, i), a.removeClass(Y.hiddenClass, i), a.removeClass(Y.hiddenClass, s), t.show(i, c, function () {
                                a.trigger(n + "." + o + ".shown", V, {})
                            })
                        }, d) : e(function () {
                            a.removeClass(Y.hiddenClass, i), a.removeClass(Y.hiddenClass, s), (t.requiresData !== !0 || t.requiresData === !0 && t.trendingLinksJson && t.trendingLinksJson.length) && t.show(t.openControl)
                        }), t.rendered = !0, a.trigger("addthis.layers." + t.name + ".rendered", V, this)))
                    },
                    superMethod: function (t, e) {
                        var n = Array.prototype.slice.call(arguments, 0);
                        return n.shift(), Y[t].apply(this, n)
                    },
                    animate: function q(t, n, o) {
                        if (t) {
                            if ("show" === n ? n = Y.showClass : "hide" === n && (n = Y.hideClass), (n === Y.showClass || n === Y.hideClass) && (t.__isAnimating = !1), t.__isAnimating) return void(a.isFunction(o) && o.call(this));
                            t.__isAnimating = !0;
                            var i = ["animationend", "webkitAnimationEnd", "oAnimationEnd", "oanimationend", "msAnimationEnd"],
                                r = ["fadeIn", "fadeInRight", "fadeInLeft", "fadeInUp", "fadeInDown", "slideInLeft", "slideInRight", "slideInUp", "slideInDown", Y.showClass],
                                s = ["fadeOut", "fadeOutRight", "fadeOutLeft", "fadeOutUp", "fadeOutDown", "slideOutLeft", "slideOutRight", "slideOutUp", "slideOutDown", Y.hideClass],
                                l = a.toObject(s),
                                c = a.toObject(r),
                                d = {},
                                u = a.isElement(t),
                                ...
                                h = function () {
                                    e(function () {
                                        c[n] ? (a.removeClass(Y.hideClass, t), a.addClass(Y.showClass, t)) : l[n] && (a.removeClass(Y.showClass, t), a.addClass(Y.hideClass, t)), a.removeClass(Y.visibleClass, t)
                                    }), a.isFunction(p) && p.call(this), a.bindEvents.call(d, d, "remove"), t.__isAnimating = !1
                                },
                                f = a.supports.csstransitions(),
                                m = r.concat(s);
                            h = h.bind(this), f ? (m.forEach(function (e) {
                                a.removeClass(e, t)
                            }), i.forEach(function (e) {
                                u ? d[e] = h : d[t + " " + e] = h
                            }), u && (d.element = t), q.evts = d, "none" === a.getCSSAttr(t, "display") && a.addClass(Y.visibleClass, t), a.bindEvents.call(d, d), a.addClass("addthis-animated", t), a.addClass(n, t)) : h()
                        }
                    },
                    processTrendingData: function (t, e, n) {
                        n && (Y.feeds[t + e] = n, Y.feedsLoading[t + e] = !1), this.dequeueTrending(t, e)
                    },
                    preRender: function () {
                        var t = this,
                            e = t.parentElement,
                            n = t.device,
                            o = t.prerender ? t.prerender() : R({
                                ".addthis-smartlayers-outer-container": ""
                            });
                        a.isElement(o) && (Y.addDeviceClassName(o, n), e.appendChild(o), t.parentElement = t.container = o)
                    },
                    render: function () {
                        var t, e, n = this,
                            o = n.options,
                        ...
                        if (h("render_layers_" + n.name, {
                                once: !0
                            }), "disabled" === n.status && n.finalize(), n.offset(), (!o.audienceRules || o.ruleSuccess) && (a.isFunction(n.generateJson) && !l ? (t = n.generateJson(n), r = R(t)) : a.isFunction(n.generateElement) && !l && (r = n.generateElement())), r) {
                            if (a.isElement(i)) {
                                if (e = n.container = n.container || r, a.addClass("addthis-smartlayers", e), n.showOnLoad !== !1 ? a.addClass(Y.hiddenClass, e) : a.addClass(Y.hideClass, e), Y.addDeviceClassName(e, s), a.supports.csstransitions() ? (o.showAnimation = o.showAnimation || "fadeIn", o.hideAnimation = o.hideAnimation || "fadeOut") : (o.showAnimation = "show", o.hideAnimation = "hide"), n.inline && i === H.body) return;
                                i.appendChild(r), i !== F && n.inline && (i.__containsLayer__ = !0), Y.render_logic.call(n, r)
                            }
                        } else Y.render_logic.call(n)
                    },
                    ...
                    postEvents: function () {
                        var t = a.getScrollBarWidth(),
                            e = "right" === this.position,
                            n = this.namespace,
                            o = this.basename,
                            i = "addthis" === n && "whatsnext" === o,
                            r = "addthis" === n && "share" === o,
                            s = this.openControl,
                            l = this.element;
                    ...
                    offset: function () {
                        var e, n, a = this.options.offset,
                            o = this.elementSelector.slice(1) + "-offset",
                            i = {};
                        if (a) {
                    ...
                    finalize: function () {
                        ...
                        return e.controlContainer && (e.controlContainer = t(e.controlContainer)[0]), e.closeControl && (e.closeControl = t(e.closeControl)[0]), e.openControl && (e.openControl = t(e.openControl)[0]), e.element && (e.element = t(e.elementSelector)[0]), "closed" === e.status && a.addClass(Y.hideClass, e.element), e.container = e.async === !0 ? e.parentElement : _ate.util.parent(e.element, ".addthis-smartlayers") === H ? e.element.parentNode : _ate.util.parent(e.element, ".addthis-smartlayers"), o && a.shareCounters.getShareCounts({
                            services: _(e.getShareServices(), function (t) {
                                return t.svc
                            }),
                    ...
                    queue: function (t, e, n) {
                        return a.queue.call(Y, t, e, n || this)
                    },
                    dequeue: function (t) {
                        return a.dequeue.call(Y, t)
                    },
                    show: function (n, o, i) {
                        var r = this,
                            s = r.element,
                    ...
                    feed: function (t) {
                        var e, n = this,
                            i = n.feedName(),
                            r = n.feeds[i] || (n.feeds[i] = []),
                            s = n.options,
                            l = o.addThisLinkFilter || s.linkFilter,
                            c = H.location.href.split("#")[0].replace(/\//g, "").replace(/(http:|https:)/, ""),
                            d = !0;
                    ...
                    feedItem: function (t) {
                        var e, n, a = t.feed || this.feed(t.test),
                            o = [];
                        if (a = a && a[t.test ? t.test.name : "filtered"], t.repeat = t.repeat || 0, a && a.length > 0) {
                            for (; a.length > 0;)
                                if (e = a.shift(), o.push(e), !e._displayed || e._displayed < t.repeat) {
                    ...
                    retrieveTrendingData: function () {
                        ...
                        var t, e = o.addthis_config || {},
                            ...
                            i = this.options.numItems,
                            r = this.processTrendingData,
                            s = Y;
                        return r = r ? r.bind(this) : function () {}, t = {
                            callback: function (t) {
                                r(n, a, t)
                            },
                            pubid: n,
                    ...
                    normalizeTrendingItem: function (t, e) {
                        var n = e.numItems || e.itemCount || 1,
                            a = e.pos || 0,
                            o = _ate.dctu({
                                url: t.url || "",
                                total: n,
                    ...
                    getTrendingFeedItems: function (t) {
                        ...
                        var n, o = Y,
                            i = this,
                            r = i.options,
                            s = o.feeds[i.options.pubid + i.options.domain],
                            l = [],
                            c = t,
                        ...
                        if (i.feeds[i.feedName()] = s, s && c) {
                            ...
                            for (var p = 0; c > p; p++) n = this.feedItem({
                                repeat: s.repeat
                            }), n && l.push(n);
                            u && (d.forEach(function (t, n) {
                                ...
                                if (-1 !== a.indexOf.call(d, e(t.url))) {
                                    ...
                                    for (var n = 0; n < l.length; n++)
                                        if (e(l[n].url) === e(t.url) || n === l.length - 1) {
                                            l.splice(n, 1);
                                            break
                                        }
                    ...
                    getNormalizedFeedItems: function (t) {
                        var e = this,
                            n = e.options,
                            a = n.maxitems || n.maxItems,
                            o = e.getTrendingFeedItems(t);
                        return o.forEach(function (n, o) {
                            e.normalizeTrendingItem(n, {
                                itemCount: t,
                                numItems: a,
                                pos: o
                            })
                    ...
                    generateTrendingJson: function (t, e) {
                        var n, a, o = e,
                            i = this,
                            r = Y,
                            s = r.feeds[i.options.pubid + i.options.domain],
                            l = i.options,
                            c = l.maxitems || l.maxItems,
                            d = l.textonly,
                            u = i.hasImage = !1,
                            p = i.hasTitle = !1,
                            h = l.defaultimage,
                            ...
                            return n.forEach(function (e, n) {
                                if (a = [], e && e.url) {
                                    if (i.normalizeTrendingItem(e, {
                                        ...
                                        var r = {};
                                        r[".at4-recommended-item-img." + f[m]] = {
                                    ...
                                    if (a.push({
                                            ...
                                            ".at4-recommended-item.at4-recommended-div-item": a
                                        }), i.requiresImage === !0 && u === !1 || p === !1) return []
                                }
                            }), g
                        }
                        return !1
                    ...
                    resizeTrendingImage: function (t) {
                        var e, n, o, i, r, s, l, c = t.parentNode.parentNode,
                            d = 0;
                        if ("closed" === this.status ? (a.addClass(Y.visibleClass, this.element), a.removeClass(Y.hideClass, this.element)) : a.isElement(this.container) && a.addClass(Y.visibleClass, this.container), a.isUndefined(t.naturalHeight) && (e = new Image, e.src = t.src, t.naturalWidth = e.width, t.naturalHeight = e.height), n = t.naturalWidth, o = t.naturalHeight, c) {
                            for (; d++ < 5 && (!c.offsetWidth || !c.offsetHeight) && c.parentNode;) c = c.parentNode;
                            if (i = c.offsetWidth, r = c.offsetHeight || o, "closed" === this.status ? (a.addClass(Y.hideClass, this.element), a.removeClass(Y.visibleClass, this.element)) : a.isElement(this.container) && a.removeClass(Y.visibleClass, this.container), s = i / n, l = r / o, s > l) {
                                o = Math.ceil(o * s), n = i;
                                try {
                    ...
                    titleResizer: function (t, e, n, o) {
                        var i = this,
                            r = 10,
                            s = 500,
                            l = i.element.parentNode;
                        return a.removeClass("at4-visually-hidden", l),
                            function c() {
                    ...
                    openShareMenu: function (t) {
                        var e = this,
                            n = (a.mobile() ? "mobile" : a.getCurrentDevice(e), s(window.addthis_share) || {}),
                            o = s(window.addthis_config) || {},
                            t = s(t) || {};
                    ...
                    share: function (t, e) {
                        ...
                        return ("email" === t || g(t)) && (n.hideEmailSharingConfirmation = this.options.hideEmailSharingConfirmation), t.match(/^(addthis|more|bkmore|compact)$/) ? Y.openShareMenu(n) : d(t, n)
                    },
                    ...
                    follow: function (t, e, n, a) {
                        ...
                        return i.product = n, i.username = this.options.pubId || window.addthis_pub || i.pubid || "", i.pubid = i.username, r.service = t, r.followUrl = z(t, e.id), "twitter" === t && A("mob") && a !== !0 && u(t, e, n, i, r, {
                            track: !1
                        }), "twitter" === t && !A("mob") || a === !0 ? (("twitter" !== t || A("mob")) && (i.ui_use_different_full_window = !0), void u(t, e, n, i, r, {
                            track: !1
                        })) : void I(t, 1, r, i)
                    },
                    imageResizer: function (t, e, n) {
                        var o = this,
                            ...
                            s = 500,
                            l = 0,
                            c = (o.container, o.element),
                            d = o.noImageClasses,
                            u = (o.hasImage, i.theme),
                            p = 0;
                        return a.addClass(Y.visibleClass, c),
                            function h() {
                                var f, m, g, v, b = -1,
                                    w = 0,
                                    x = {};
                                ...
                                l++, w < (o.maxitems || 1) && r > l ? a.requestTimeout(h, s) : (i.hideBadImages !== !1 && (e.forEach(function (t) {
                                    ...
                                    a.isImageBroken(t) && (o.showPlaceholderImages === !1 ? (g = _ate.util.parent(t, ".at4-recommended-div-item"), g !== H && g !== H.body && g.parentNode && g.parentNode.removeChild(g), p >= o.maxitems && a.addClass(Y.hideClass, o.container || o.element)) : (v = _ate.util.parent(t, ".at4-recommended-item-img"), o.hasImage === !0 && p < o.maxitems ? (v !== H && v !== H.body && a.addClass(d[u] || "", v), x[".at4-recommended-item-placeholder-img"] = "", t.parentNode && t.parentNode.removeChild(t), v.appendChild(R(x))) : o.hasImage === !0 && p >= o.maxitems && a.addClass(Y.hideClass, o.container || o.element)))
                                })), a.removeClass(Y.visibleClass, c), a.isFunction(n) && a.requestTimeout(function () {
                                    n()
                                }, 100))
                            }(), o
                    },
                    mappedDataAttributes: function () {
                        ...
                        for (var n in Y.defaultOptions) Y.defaultOptions.hasOwnProperty(n) && l(Y.defaultOptions[n]) && Object.keys(Y.defaultOptions[n]).forEach(e);
                        return Y.mappedDataAttributes.cached = t, t
                    },
                            ...
                            for (e in t)
                                if (t.hasOwnProperty(e)) {
                                    ...
                                    if ("pinterest" === d && (d = "pinterest_share"), o.services_exclude[d] !== !0 && (m(d) || 1 === r[d] || s === i && this.personalized)) {
                                        if ("more" === d || "addthis" === d || s === i && this.personalized) o.services_exclude.more !== !0 && (c = x("More", 2).replace("&nbsp;", " "), d = "compact");
                                        else {
                                            var u = n(673);
                                            c = u(d), c === !1 && (c = v(d))
                                        }
                    ...
                    promoteService: function (t) {
                        if ("string" == typeof t.service) {
                            var e = t.service.toLowerCase(),
                                n = t.numServices || this.preferredServices.length,
                                a = this.services || [];
                            this.services = L(e, {
                                availableServices: a,
                                maxServices: n
                    ...
                    checkForHideCookie: function (t, e) {
                        if (!t || !e) return !1;
                        var n = _ate.cookie.rck("__at" + t + e),
                            a = n ? _ate.util.fromKV(n) : {};
                        return "1" === a.h
                    },
    ...
    809: function (t, e, n) {
        ...
        e["default"] = function (t) {
            var e = window,
                n = e.addthis_config ? s["default"](e.addthis_config) : {},
                a = e.addthis_share ? s["default"](e.addthis_share) : {},
                o = t.getShareUrl(),
                r = t.getShareTitle(),
                l = t.getShareDescription(),
                c = t.getShareMedia(),
                d = t.getHideEmailSharingConfirmation();
    ...
    812: function (t, e) {
        ...
        t.exports = function o(t) {
            ...
            if (t) {
                ...
                else if (c && "object" == typeof c && 1 === c.nodeType) s.appendChild(c);
                else
                    for (var l in c)
                        if (c.hasOwnProperty(l))
                            if (d = c[l], "string" == typeof d && l.indexOf(".") < 0 && (l.indexOf("#") < 0 || 1 === l.length) && !h(l.toLowerCase()))
                                if ("html" === l) s.appendChild(document.createTextNode(d));
                                else if ("style" === l && (_ate.bro.ie6 || _ate.bro.ie7 || _ate.bro.msi && "backcompat" === a.compatMode.toLowerCase())) {
                    for (var m, g, v, b = d.split(";"), w = -1; ++w < b.length;)
                        if (m = b[w], g = m.substring(0, m.indexOf(":")), v = m.substring(m.indexOf(":") + 1, m.length), g && v) try {
                            s.style[g] = v
                        } catch (x) {}
                } else "className" === l || "class" === l ? s.className = d : s.setAttribute(l, d);
                else if ("children" == l)
                    for (var f in d) s.appendChild(o(d[f]));
                else {
    ...
    813: function (t, e, n) {
        ...
        function a(t, e) {
            ...
            switch (n) {
                case "ctbx":
                    return e.style = _.FIXED, e.hideLabel = !0, e.responsive = "0px", e.borderRadius = d(e), e.size = u(e), e.counts = s(e), e.buttonColor = h(e), e.shareCountThreshold = e.shareCountThreshold || 0, e;
                case "tbx":
                case "sharetoolbox":
                    return e.style = _.FIXED, e.hideLabel = !0, e.responsive = "0px", e.borderRadius = d(e), e.size = u(e), e.counts = s(e), e.buttonColor = h(e), e.shareCountThreshold = e.shareCountThreshold || 0, e;
                case "resh":
                case "responsiveshare":
                    return e.style = _.RESPONSIVE, e.borderRadius = d(e), e.size = u(e), e.counts = s(e), e.buttonColor = h(e), e.shareCountThreshold = e.shareCountThreshold || 0, e;
                case "jsc":
                case "jumboshare":
                    return e.style = _.RESPONSIVE, e.size = u(e), e.counts = "jumbo", e.label = e.label || e.title || "SHARES", e.countsFontSize = e.countsFontSize || "60px", e.titleFontSize = e.titleFontSize || "18px", e.counterColor = e.counterColor || e.color || "#555B64", e.buttonColor = h(e), e.borderRadius = d(e), e.shareCountThreshold = e.shareCountThreshold || 0, e;
                default:
                    return e
            }
        }
        ...
        function o() {
            var t = [],
                e = b.pcosMockedAsTwoClientTools;
            ...
            return Object.keys(t).forEach(function (n) {
                ...
                switch ("[object Array]" !== Object.prototype.toString.call(a) && (a = [a]), n) {
                    ...
                    case "floatingsidebar":
                        a.forEach(function (t) {
                            var n, a = t.desktopPosition || "hide",
                                o = t.mobilePosition || "hide";
        ...
        function s(t) {
            ...
            return y.counts[e] || e || x.NONE
        }

        function l(t) {
            var e = s(t);
            return e === x.SUM || e === x.EACH || e === x.JUMBO || e === x.BOTH
        }
        ...
        function p(t) {
            return t.counts ? y.counts[t.counts] || t.counts : x.NONE
        }
        ...
        var f = n(814),
            ...
            w = {
                rpsl: function (t) {
                    var e = t.desktopPosition,
                        n = t.mobilePosition;
                    return "hide" === e && "hide" !== n ? (t.id = "wnm", "bottom" === n && (t.offset = {
                        bottom: "0px"
                    })) : "hide" !== e && "hide" === n && (t.id = t.numPosts > 1 ? "tst" : "smlwn", "left" === e ? t.offset = f({
                        left: "0px"
                    }, t.offset) : t.offset = f({
                        right: "0px"
                    }, t.offset)), t
    ...
    815: function (t, e) {
        "use strict";
        t.exports = function () {
            var t = Math.random() * Math.pow(36, 4) << 0,
                e = t.toString(36),
                n = ("0000" + e).slice(-4);
            return n
        }
        ...
        a = function () {
            var t = function () {
                ...
                function s(t, n, a, o, i, r, s, l, d, u, p) {
                    ...
                    if (a && (v = a.match(I)))
                        for (h = v.length; h--;)
                            if (!e(v[h].slice(1)).test(this.className)) return !1;
                    if (d && b.pseudos[d] && !b.pseudos[d](this, p)) return !1;
                    if (o && !s) {
                        g = this.attributes;
                        for (m in g)
                            if (Object.prototype.hasOwnProperty.call(g, m) && (g[m].name || m) == i) return this
                    }
                    return o && !c(r, $(this, i) || "", s) ? !1 : this
                }

                function l(t) {
                    return Z.g(t) || Z.s(t, t.replace(B, "\\$1"))
                }
                ...
                function c(t, e, n) {
                    switch (t) {
                        case "=":
                            return e == n;
                        case "^=":
                            return e.match(J.g("^=" + n) || J.s("^=" + n, "^" + l(n), 1));
                        case "$=":
                            return e.match(J.g("$=" + n) || J.s("$=" + n, l(n) + "$", 1));
                        case "*=":
                            return e.match(J.g(n) || J.s(n, l(n), 1));
                        case "~=":
                            return e.match(J.g("~=" + n) || J.s("~=" + n, "(?:^|\\s+)" + l(n) + "(?:\\s+|$)", 1));
                        case "|=":
                            return e.match(J.g("|=" + n) || J.s("|=" + n, "^" + l(n) + "(-|$)", 1))
                    }
                    return 0
                ...
                function u(t, e, n) {
                    ...
                    for (var o, i, l = e.split(","); e = l.pop();)
                        if (o = Q.g(e) || Q.s(e, e.split(G)), i = e.match(W), o = o.slice(0), s.apply(t, r(o.pop())) && (!o.length || p(t, o, i, n))) return !0;
                    return !1
                }
                ...
                function g(t) {
                    return t ? "string" == typeof t ? b(t)[0] : !t[S] && m(t) ? t[0] : t : _
                }

                function v(t, e, n) {
                    return 9 === t[S] ? t.getElementById(e) : t.ownerDocument && ((n = t.ownerDocument.getElementById(e)) && X(n, t) && n || !X(t, t.ownerDocument) && x('[id="' + e + '"]', t)[0])
                }
                ...
                var x, _ = document,
                    ...
                    W = new RegExp("(" + L.source + ")" + j.source, "g"),
                    G = new RegExp(L.source + j.source),
                    Y = new RegExp(U.source + "(" + H.source + ")?(" + F.source + ")?"),
                    q = {
                        " ": function (t) {
                ...
                var K = new t,
                    ...
                    J = new t,
                    Q = new t,
                    X = "compareDocumentPosition" in y ? function (t, e) {
                    ...
                    ot = function (t) {
                        "undefined" != typeof t[A] && (x = t[A] && et ? nt : at)
                    };
                return ot({
                    useNativeQSA: !0
                }), b.configure = ot, b.uniq = f, b.is = u, b.pseudos = {}, b
            }();
            return t
    ...
    818: function (t, e, n) {
        var a, o, i = n(4),
            ...
            u = c.body,
            p = d.addthis;
        a = [n(816), n(817), n(357)], o = function (t, e, a) {
            var o = {
                KEYCODES: {
                    13: "enter",
                    27: "esc"
                ...
                match: function (t, e, n) {
                    var a, i, r, s, l, c, d, u = t ? Object.keys(t) : [],
                        p = JSON.stringify(t);
                    if (a = n + "//" + u.join("/"), i = o.match[a] || (o.match[a] = {}), !i.matches)
                        for (r = i.matches || (i.matches = []), i.keys = u, i.values = i.values || e, s = 0; s < e.length; s++) {
                ...
                filter: function (t, e, n) {
                    ...
                    for (var r = 0, s = t.length; s > r; r++) a = t[r], o = e.call(n || a, a, r, t), o && (i[i.length] = a);
                    return i
                },
                map: function (t, e, n) {
                    var a, o = [];
                ...
                bindEvents: function (t, e) {
                    ...
                    for (var a in t)
                        if (t.hasOwnProperty(a) && t[a] instanceof Function) {
                            var i = a.lastIndexOf(" "),
                                r = t[a].bind(this);
                            if (-1 === i) o.has(a, "addthis") ? "remove" !== e ? _ate.ed.addEventListener(a, r) : _ate.ed.removeEventListener(a, r) : n && o.listenTo({
                                ...
                                var s = "!" === a.charAt(0) ? a.substring(1, i) : a.substring(0, i),
                                    l = a.substring(i + 1);
                                o.listenTo({
                ...
                listenTo: function (e) {
                    var n = !1,
                        ...
                        s = e.ev,
                        l = e.callback,
                        u = "remove" !== e.type ? "addEventHandler" : "removeEventHandler",
                        p = e.originalEv;
                    (r || i) && s && l && (i ? o[u]({
                        container: i,
                    ...
                    var e = t.container,
                        ...
                        l = function (e) {
                            ...
                            if (a) {
                                ...
                                for (var c = s.match(/^[^\.\#]+/g) || [], u = s.match(/\.[^\.\#]+/g) || [], p = s.match(/\#[^\.\#]+/g) || []; l && l !== t.container;) {
                                    if (n(l)) return r(e, l);
                                    l = l.parentNode
                                }
                            }
                ...
                elementInViewport: function (e) {
                    ...
                    for (var n = e.offsetTop, a = e.offsetLeft, i = e.offsetWidth, l = e.offsetHeight, u = d.pageYOffset ? d.pageYOffset : c.documentElement.scrollTop, p = d.pageXOffset ? d.pageXOffset : c.documentElement.scrollLeft, h = s(), f = r(); e.offsetParent;) e = e.offsetParent, n += e.offsetTop, a += e.offsetLeft;
                ...
                supports: {
                    csstransitions: function () {
                        ...
                        for (var a = 0; a < n.length; a++)
                            if (o.isString(t[n[a] + e])) return o.supports.csstransitions.supports = !0, !0;
                ...
                removeClass: function (t, e) {
                    if (e && e.className && o.isElement(e) && o.isString(t)) {
                        ...
                        if (o.hasClass(t, e))
                            if (e.classList && o.isString(t) && t.length) e.classList.remove(t);
                            else {
                ...
                getCSSAttr: function (t, e, n) {
                    ...
                    var a = t.currentStyle || d.getComputedStyle(t, null) || {},
                        i = function () {
                ...
                setCSSAttr: function (t, e, n) {
                    if (o.isElement(t))
                        if (o.isString(e) && o.isString(n)) t.style[e] = n;
                        else if (o.isPlainObject(e))
                        for (var a in e) e.hasOwnProperty(a) && (t.style[a] = e[a])
                },
                ...
                attr: function (t, e, n) {
                    if (o.isElement(t) && !o.isUndefined(e))
                        if (o.isUndefined(n)) {
                ...
                getTopService: function (t) {
                    var e = p.user.services() || [],
                        n = {
                            google_plus: "google_plusone_share"
                        };
                    return o.isUndefined(t) || "preferred" === t ? (t = e.length > 0 ? e[0] : {
                        name: "facebook"
                    }, t.name) : t in n ? n[t] : t
                },
                ...
                isCSSReady: function (t) {
                    ...
                    e.id = "addthissmartlayerscssready", e.style.color = "#fff", c.body.appendChild(e),
                        function n() {
                ...
                getScrollBarWidth: function f() {
                    ...
                    var t = 0;
                    if (!o.isUndefined(o.getCSSAttr(u, "-ms-overflow-style")) && i("msi")) "none" !== o.getCSSAttr(u, "-ms-overflow-style") && (t = o.scrollBarWidth());
                    else if (d.getComputedStyle && (t = o.scrollBarWidth(), 0 === t)) {
                ...
                scrollBarWidth: function () {
                    var t, e, n, a = c.createElement("div"),
                        i = c.createElement("div");
                    return o.setCSSAttr(a, {
                        width: "100px",
                        height: "10000px"
                    }), o.setCSSAttr(i, {
                        width: "100%",
                ...
                indexOf: function (t) {
                    var e = function (t) {
                        ...
                        for (e = 0; e < this.length; e++)
                            if (this[e] === t || decodeURIComponent(this[e]) === decodeURIComponent(t)) {
                                n = e;
                                break
                            }
                        return n
        ...
        t.exports = {
            ...
            defaults: {
                cb: function (t) {
                    var e = t.params,
                        n = t.data,
                        o = Number(n.count) || Number(n.shares);
        ...
        e["default"] = function (t, e, n, a) {
            l.string(t) && (t = [t]), l.array(t) && ! function () {
                ...
                if (c.combCounts) s["default"]({
                    ...
                    for (var l = 0; l < t.length; l++) i["default"]({
                        elem: a,
                        countUrl: e,
                        service: t[l]
                    }, r)
    ...
    825: function (t, e, n) {
        ...
        e["default"] = function (t, e) {
            ...
            var o = i["default"].defaults,
                s = a.cb || o.cb || function () {},
            ...
            if (a.jsonpParam = a.jsonpParam || o.jsonpParam || "callback", p === r.PENDING_RESPONSE) c.putCallback(n, u, e);
            else if (p === r.RESPONDED) s({
                params: t,
    ...
    827: function (t, e) {
        ...
        var a = function () {
            ...
            return t.prototype.put = function () {
                ...
                for (var t = Array.prototype.slice.call(arguments, 0), e = this._store; t.length > 1;)
                    if (e = e[t.shift()], void 0 === e) return void 0;
                return e[t.shift()]
            }, t
        }();
    ...
    829: function (t, e, n) {
        ...
        var a = n(816),
            ...
            d = n(74),
            u = n(17),
            p = n(811).getLayerNameByPcoConfig,
            h = n(813).transformLayersConfig,
            f = n(30),
            m = n(832),
            g = n(771),
            v = i.layerList,
            ...
            w = function x(t, e) {
                if (arguments.length) {
                    if (o.isString(t) && o.isPlainObject(e) && !o.isEmptyObject(e)) return void r.thirdPartyWidget.apply(this, arguments);
                    t = t || {};
                    var n = {},
                        s = {},
                        w = {
                            _init: function (t, e) {
                                x.initialized || this._globalEventHandlers(), m(t, _ate.du);
                                var n = w._setDefaultOptions(t);
                                w._createLayers(t, n, function (t) {
                                    o.isFunction(e) && e(n, t)
                                })
                            },
                            _globalEventHandlers: function () {
                                return o.bindEvents(i.globalEvents || {}), o.mobile() || o.bindEvents(i.desktopEvents || {}), this
                            },
                            _setDefaultOptions: function (t) {
                                var e = o.cloneObject(i.defaultOptions),
                                    n = t.responsive,
                                    a = function (t, e) {
                                        o.isPlainObject(t) && (o.isPlainObject(e) ? o.extend(t, e) : e === !1 ? t.responsive = e : (o.isString(e) || o.isNumber(e)) && o.extend(t, {
                                            responsive: {
                                                maxWidth: e
                                            }
                                        }))
                                    };
                                e.domain = f.dh, o.mobile() || void 0 === n || a(e, n);
                                for (var r in t)
                                    if (t.hasOwnProperty(r)) {
                                        var s = t[r];
                                        if (o.isArray(s))
                                            for (var l = 0; l < s.length; l++) a(s[l], (s[l] || {}).responsive);
                                        else a(s, (s || {}).responsive)
                                    }
                                for (var c in e)
                                    if (e.hasOwnProperty(c) && (t[c] || "" === t[c])) {
                                        var d = e[c];
                                        o.isPlainObject(d) ? o.isArray(t[c]) && t[c].length ? o.extend(d, t[c][0]) : o.extend(d, t[c]) : e[c] = t[c]
                                    }
                                return e
                            },
                            _removeConflicts: function (t, e, a) {
                                var o = i.conflicts,
                                    ...
                                    s = r.map(function (n) {
                                        var a = n.positionProperty,
                                            o = n.positionTransform,
                            ...
                            _createLayers: function (t, e, a) {
                                var r, s = o.mobile() ? "mobile" : "desktop",
                                    c = Object.keys(v).reduce(function (t, e) {
                                        return t[e] = v[e], t
                                    }, {});
                                if (delete c.addthis, r = t.showMobileOnDesktop === !0 ? i.getAllLayers() : i.layers(), i.language = u(), /^en(?:$|\-)/.test(i.language) || Object.keys(i.translationIds).filter(function (t) {
                                        return i.defaultOptions[t]
                                    }).forEach(function (t) {
                                        if (i.defaultOptions[t]) {
                                            var e = i.translationIds[t],
                                                n = i.defaultOptions[t];
                                            Object.keys(e).forEach(function (t) {
                                                n[t] && (n[t] = d(n[t], e[t]))
                                            })
                                        }
                                    }), Object.keys(r).forEach(function (e) {
                                        t[e] && (i.enabledLayers[e] = !0, r[e].split(",").filter(function (e) {
                                            return t[e] !== !1 && v.addthis[e] && ((!l.hasToolConfigs() || "mobile" !== e) && v.addthis[e].plugin !== !0 || v.addthis[e].plugin === !0 && void 0 !== t[e])
                                        }).forEach(function (t) {
                                            n[t] = !0
                                        }))
                                    }), !l.hasToolConfigs() && (o.isEmptyObject(t) && void 0 === t.mobile || t.share && t.share.mobile !== !1 || t.follow && t.follow.mobile !== !1) && t.responsive !== !1 && "desktop" === s && !o.isIEQuirksMode()) {
                                    var p = t.mobile || !0;
                                    n = o.extend(n, {
                                        mobile: !0
                                    }), t = o.extend(t, {
                                ...
                                o.isPlainObject(c) && (n = o.extend(o.cloneObject(c), n)), w._removeConflicts(e, t);
                                var h = Object.keys(n).filter(function (t) {
                                    var e = !x[t] || v.addthis && v.addthis[t] && v.addthis[t].multipleCalls === !0;
                                    return x[t] = !0, e
                                }).map(function (n) {
                                    return t[n] ? t[n][s] !== !1 && (o.isArray(t[n]) ? t[n].forEach(function (t) {
                                        o.trigger("addthis.layers." + n, {
                                            name: n,
                                            props: v.addthis[n],
                                            options: t,
                                        ...
                                        options: t[n],
                                        extendedOptions: e
                                    })) : t[n] !== !1 && o.trigger("addthis.layers." + n, {
                                        name: n,
                                        props: v.addthis[n],
                                        options: t[n],
                                        extendedOptions: e
                            ...
                            destroy: function (t) {
                                var e, n = o.isString(t),
                                    r = (t || "").split("."),
                                    s = r.length > 1 ? r[0] : "addthis",
                                    l = r.length > 1 ? r[1] : t,
                                    d = c.get(),
                                    u = d[s],
                                    p = {},
                                    h = [];
                                return Object.keys(i.enabledLayers).forEach(function (t) {
                                    u && u[t] || (x[t] = !1)
                                }), !n || u && u[l] ? (n ? (p = i.activeFloatingWidgets[l] ? i.activeFloatingWidgets[l] : [u[l]], h = Object.keys(p).map(function (t) {
                                    var e = p[t];
                                    return e.inlineClass ? a("." + e.inlineClass) : _ate.util.parent(e.element, ".addthis-smartlayers") === document ? e.element : _ate.util.parent(e.element, ".addthis-smartlayers")
                                })) : (p = u, h = a(".addthis-smartlayers")), Object.keys(p || {}).forEach(function (t) {
                                    var n = p[t];
                                    o.isPlainObject(n) && !o.isEmptyObject(n) && (e = o.extend(n.events || {}, n.customEvents || {}), o.trigger(s + "." + n.basename + ".destroy", window.addthis || {}, n), o.bindEvents.call(n, e, "remove"), x[n.basename] = !1, n.rendered = !1, o.removeElement(n.openControl), o.removeElement(n.placeholder))
                                }), h.forEach(function (t) {
                                    o.removeElement(t)
                                }), n ? (c.destroy(s, l), i.activeFloatingWidgets[l] && delete i.activeFloatingWidgets[l]) : c.destroy(), o.isEmptyObject(c.get()) && (i.activeFloatingWidgets = {}, x.initialized = !1, i.initialized = !1), this) : "not an active layer"
                            }
                        };
                    if (b = o.publicApi(w), _ate.ipc) {
                        var _ = e && e.cfs;
                        _ ? g.markDashboard() : g.markSmartLayers()
                    } else g.markSmartLayers();
                    if (t.pii === !0 && i.receivedConfigFromServer) return i.pageConfigs.forEach(function (t, e) {
                        for (var n in t)
                            if (t.hasOwnProperty(n)) {
                                var a = i.layerList.addthis;
                                a[n] && a[n].inlineClass && (s[n] = t[n], i.pageConfigs.splice(e, 1))
                            }
                    }), void(Object.keys(s) > 0 && (s = o.extend(s, {
                        pi: !0
                    }), addthis.layers(s)));
                    if (!_ate.ipc || t.pi) {
                        if (o.isFunction(t)) return void t.call(b, b);
                        t = o.isPlainObject(t) && !o.isEmptyObject(t) ? t : {}, w._init(t, function (t, n) {
                            var a = n.length,
                                i = 0,
                                r = 0;
                            return 0 === a ? (o.isFunction(e) && e.call(b, b), o.trigger("addthis.layers.loaded"), o.trigger("addthis.layers.rendered")) : (_ate.ed.addEventListener("addthis.layer.loaded", function () {
                                r += 1, r === a && o.trigger("addthis.layers.loaded")
                            }), _ate.ed.addEventListener("addthis.layer.rendered", function () {
                                i += 1, i === a && (o.isFunction(e) && e.call(b, b), o.trigger("addthis.layers.rendered"))
                            }), x.initialized = !0, x.onpage = !0), b
                        })
                    } else if (t.cfs || o.isFunction(e) && e.cfs === !0) {
                        if (t._default && t._default.widgets) {
                            var y = {};
                            for (var k in t._default.widgets)
                                if (t._default.widgets.hasOwnProperty(k)) {
                                    var C = t._default.widgets[k],
                                        M = C.id || k;
                    ...
                    } else i.pageConfigs.push(t)
                }
            };
        w.lastViewRegistered = (new Date).getTime(), w.refresh = function (t, e) {
            var n, a = _ate.track.gtf(),
                o = a.children[0],
                i = (new Date).getTime();
            if (o || _ate.log.error("Could not find the sh frame!"), window.addthis_share = window.addthis_share || {}, f.rescan(), "string" == typeof t && t.length > 0 ? window.addthis_share.url = t : window.addthis_share.url = f.du, "string" == typeof e ? window.addthis_share.title = e : window.addthis_share.title = f.title, _ate.du = _ate.truncateURL(f.du), i - w.lastViewRegistered > 500 && o) {
                w.lastViewRegistered = i, n = o.src, a.removeChild(o), _ate.sid = _ate.util.cuid();
                var r = _ate.track.ctf();
                r.src = n.replace(/sid\=[a-zA-Z0-9]+/, "sid=" + _ate.sid), _ate.track.gtf().appendChild(r);
                var c = l.getLayersConfig();
                c && addthis.layers(s({
                    cfs: 1
                }, c))
            }
    ...
    830: function (t, e, n) {
        var a, o, i = n(591).elementRequiresFacebookSDK,
            r = n(592),
            s = n(17);
        a = [n(816), n(818), n(807), n(831)], o = function (t, e, n, a) {
            var o = n.layerList;
            return {
                addthisWidget: function (t, n) {
                    ...
                    return o[i] = o[i] || {}, o[i][r] = n, addthis.addEventListener("addthis.layers." + t, function (t) {
                        var n = t.target.name,
                            o = e.extend(t.target.props, {
                                namespace: i,
                                basename: r
                            }),
                            s = t.target.options || {},
                            l = t.target.extendedOptions || {};
                        a.createWidget({
                            name: n,
                            props: o,
    ...
    831: function (t, e, n) {
        var a, o, i = n(31),
            ...
            c = n(810),
            d = n(4);
        a = [n(807), n(816), n(818)], o = function (t, e, n) {
            var a = i(window.location.search),
                o = window,
                u = (document, o.addthis),
                p = t.layerList,
                h = {
                            ...
                            if ("addthis" === _) {
                                for (v in m)
                                    if (m.hasOwnProperty(v)) {
                                        var O = m[v];
                                        n.isUndefined(p[_][v]) ? z[v] = O : I[v] = O
                                    }
                                x = n.extend(n.extend(n.cloneObject(z), n.cloneObject(t.defaultOptions[y])) || {}, n.extend({
                                    layers: I
                                }, n.cloneObject(f)))
                            } else if (n.isUndefined(p[_]))
                                for (v in m) m.hasOwnProperty(v) && (z[v] = m[v]);
                            else
                                for (v in m) m.hasOwnProperty(v) && (I[v] = m[v]);
                            if ("addthis" !== _ && (x = n.extend(n.extend(n.cloneObject(z), n.cloneObject(t.defaultOptions[_][y])) || {}, n.extend({
                                    layers: I
                                }, n.cloneObject(f)))), n.isString(r.inheritsFrom) && r.inheritsFrom.length) {
                                if (k.names = r.inheritsFrom.split("."), k.namespace = k.names[0], k.basename = k.names[1], k.namespace && k.basename && n.isPlainObject(p[_][y])) C = n.cloneObject(p[k.namespace][k.basename]), E = n.extend(C, r), A = n.cloneObject("addthis" === k.namespace ? t.defaultOptions[k.basename] : t.defaultOptions[k.namespace][k.basename]), M = n.extend(A, x);
                                else if (k.namespace && !k.basename) {
                                    if (C = p.addthis[k.namespace], !C) return;
                                    E = p[_][y] = n.extend(n.cloneObject(C), r), A = n.cloneObject(t.defaultOptions[k.namespace]), M = n.extend(A, x)
                                }
                                b = function () {
                                    for (var t in E) E.hasOwnProperty(t) && (this[t] = E[t])
                                }
                            }
                            return p[_][y].__numCalls__ = n.isUndefined(S) || r.multipleCalls !== !0 ? 1 : S + 1, b.prototype = t, g = new b, g.element = g.element || "#addthis-smartlayers-" + i, g.__numCalls__ = p[_][y].__numCalls__, g.__numCalls__ > 1 && (g.element = g.element + g.__numCalls__, g.closeControl = g.closeControl ? g.closeControl + g.__numCalls__ : g.closeControl, g.openControl = g.openControl ? g.openControl + g.__numCalls__ : g.openControl), g.elementSelector = g.element, g.name = i, g.mobile = n.mobile(), g._super = t, g.inheritedObj = C, n.isString(g.parentElement) && (g.parentElement = e(g.parentElement)[0]), r.inheritsFrom ? g.options = M : g.options = x, g.options.pubid = g.options.altRecommendedPubId || g.options.pubid || o.addthis_pub || w.pubid || "", n.mobile() && g.options.mobile === !1 || n.desktop() && g.options.desktop === !1 ? (n.trigger("addthis.layer.loaded", {
                                layer: g
                            }), n.trigger("addthis.layer.rendered", {
                                layer: g
                            }), !1) : (g.qwery = e, g.utils = n, g.rendered = !1, g.device = g.device || "both", g.options.elements && !e(g.options.elements).length ? (n.trigger("addthis.layer.loaded", {
                                layer: g
                            }), n.trigger("addthis.layer.rendered", {
                                layer: g
                            }), !1) : h.isHiddenByConfig(f) ? (n.trigger("addthis.layer.loaded", {
                                layer: g
                            }), n.trigger("addthis.layer.rendered", {
                                layer: g
                            }), !1) : (d("mob") && g.events && (g.events = s(g.events, function (t) {
                                return !/\bmouse/.test(t)
                            })), g.create(), (g.async === !0 || n.isFunction(g.prerender)) && t.preRender.call(g), g.render(), g.pco && l.addPCO(g.pco), n.trigger("addthis.layers." + this.name + ".loaded", u, this), n.trigger("addthis.layer.loaded", {
                                layer: g
                            }), c.put(_, y, g), r.inline || (t.activeFloatingWidgets[i] = t.activeFloatingWidgets[i] || {}, t.activeFloatingWidgets[i][f.widgetId || "defaultId"] = g), g))
                        }
                    },
                    isHiddenByConfig: function (t) {
                        ...
                        if (t.__hideOnUrls)
                            for (var a = n.stripHashFromPath(n.stripProtocol(o.location.href)), i = 0; i < t.__hideOnUrls.length; i++) {
    ...
    832: function (t, e, n) {
        ...
        e["default"] = function (t) {
            ...
            if (!(u["default"](e) || e.indexOf(".addthis.com".substr(1)) > -1 || e.indexOf(".clearspring.local".substr(1)) > -1)) {
    ...
    833: function (t, e, n) {
        var a, o;
        n(834), a = [n(818), n(830), n(807), n(816), n(836)], o = function (t, e, n, a) {
            return e.addthisWidget("dock", {
                inheritsFrom: "mobile"
            })
        }.apply(e, a), !(void 0 !== o && (t.exports = o))
    },
    ...
    836: function (t, e, n) {
        ...
        var i = n(573),
            ...
            p = n(675),
            h = n(50),
            f = n(28).isBrandingReduced(),
            m = n(656);
        a = [n(818), n(830), n(807), n(357), n(816)], o = function (t, e, a, o, g) {
            var v = window,
                b = document,
                w = b.body,
                x = v.addthis,
                _ = o.li(o.a(o.div().css(), o.span().css("at4-label", "atservice"))).css("at4m-listitem").element;
            return e.addthisWidget("mobile", {
                create: function () {
                    var e, n, a = this,
                        o = a.basename,
                        i = this.options || {},
                        r = i.layers.share || {},
                        s = "mobile" === o ? r.services : i.shareServices,
                        l = function () {
                            return v.addthis_config && t.isPlainObject(v.addthis_config) ? v.addthis_config.services_exclude || "" : ""
                        }(),
                        c = {};
                    return this.initialize(), this.position = i.buttonBarPosition && "top" === i.buttonBarPosition.toLowerCase() ? "top" : "bottom", e = n = "", a.options = t.extend(i, {
                        menuShowAnimation: e,
                        menuHideAnimation: n,
                        buttonBarTheme: "transparent" === i.buttonBarTheme ? "light" : i.buttonBarTheme
                    }), a.positionClass = "top" === a.position ? ".at4m-dock-top" : ".at4m-dock-bottom", s ? (this.personalized = !1, this.services = s.replace(/ /g, "").split(",").concat(a.preferredServices)) : this.services = a.preferredServices, "string" == typeof l && (l = l.split(","), l.forEach(function (e) {
                        e = t.trim(e), c[e] = !0
                    }), i.services_exclude = c), a
                },
                initialize: function () {
                    function e(e) {
                        if (this.mobile && (this.history.replaceState(e.state, b.title, v.location.href), e.state && e.state.menu === !1 && e.state.opening === !0 ? t.trigger("addthis.layers.mobilemenu.hide", x, this) : e.state && e.state.menu === !1 && e.state.empty === !0 && v.history.go(-1), e.state && e.state.menu)) switch (e.state.menu) {
                            case "share":
                                a.events["#at4m-sb click"].call(a, e);
                                break;
                            case "follow":
                                a.events["#at4m-fb click"].call(a, e)
                        }
                    }
                    var n, a = this,
                        o = v.history.replaceState,
                        i = v.history.pushState;
                    a.mobile && o && i ? (this.history = {}, this.history.getState = function () {
                        return v.history.state ? v.history.state : v.sessionStorage && (n = v.sessionStorage.getItem("history.state")) && JSON.parse(n) || null
                    }, this.history.pushState = function (t, e, n) {
                        i.call(v.history, t, e, n);
                        try {
                            v.sessionStorage.setItem("history.state", JSON.stringify(t)), v.sessionStorage.setItem("history.state:title", e), v.sessionStorage.setItem("history.state:href", n)
                        } catch (a) {}
                    }, this.history.replaceState = function (t, e, n) {
                        o.call(v.history, t, e, n);
                        try {
                            v.sessionStorage.setItem("history.state", JSON.stringify(t)), v.sessionStorage.setItem("history.state:title", e), v.sessionStorage.setItem("history.state:href", n)
                        } catch (a) {}
                        ...
                        menu: !1,
                        opening: !1
                    }, b.title, v.location.href)) : this.history = {}, this.popStateEventHandler = e
                },
                pco: "smlmo-1.0",
                device: "mobile",
                ...
                finalize: function () {
                    return this.element = g(this.element)[0], this.dock = g(this.dock)[0], this.dockToggle = g(this.dockToggle)[0], this.menu = g(this.menu)[0], this.menuHeader = g(this.menuHeader)[0], this.menuCloseControl = g(this.closeControl)[0], this.menuBody = g(this.menuBody)[0], this.searchBox = g(this.searchBox)[0], this.searchClear = g(this.searchClear)[0], this.innerMenuBody = g(this.innerMenuBody)[0], t.trigger("addthis.layer.rendered", {
                        layer: this.name
                    }), this
                },
                events: {
                    "!window popstate": function (t, e) {
                        this.popStateEventHandler(t)
                    },
                    ".at4m-listitem a.at4m-share click": function (e, n) {
                        var a = n && n.getAttribute("svc");
                        a && (this.superMethod("share", a, this.pco), t.preventDefaultEvent(e))
                    },
                    "#at4m-fb click": function () {
                        var t = Array.prototype.slice.call(arguments);
                        a.commonEventHandlers.mobile.showExpandedMenu.apply(this, t.concat(!0))
                    },
                    "#at4m-sb click": a.commonEventHandlers.mobile.showExpandedMenu,
                    "#at4m-mcc click": function (e, n) {
                        t.preventDefaultEvent(e), t.trigger("addthis.layers.mobilemenu.hide", x, this)
                    },
                    "#at4m-dock-toggle click": function (e, n) {
                        t.preventDefaultEvent(e), this.dockClosed ? t.trigger("addthis.layers.dock.show", x, this) : t.trigger("addthis.layers.dock.hide", x, this)
                    },
                    "addthis.layers.dock.show": function () {
                        this.show(this.dock, this.options.showAnimation, function () {
                            this.dockClosed = !1
                        }), t.removeClass("at4-dock-toggle-active", this.dockToggle)
                    },
                    "addthis.layers.dock.hide": function () {
                        t.addClass("at4-dock-toggle-active", this.dockToggle), this.hide(this.dock, this.options.hideAnimation, function () {
                            this.dockClosed = !0
                        })
                    },
                    "._at-mobile-print-btn click": function (t, e) {
                        function n() {
                            var t;
                            _ate.bro.dro === !1 && window.print && "function" == typeof window.print ? window.print() : (t = _ate.ajs("https://www.google.com/cloudprint/client/cpgadget.js", !0), t && (t.readyState ? t.onreadystatechange = function () {
                                ("loaded" === t.readyState || "complete" === t.readyState) && (t.onreadystatechange = null, a())
                            } : void 0 !== t.onload ? t.onload = function () {
                                a()
                            } : void 0 !== window.cloudprint && a()))
                        }

                        function a() {
                            if (window.cloudprint && window.cloudprint.Gadget) {
                                var t = new cloudprint.Gadget,
                                    e = window,
                                    n = e.document;
                                t.setPrintDocument(n.contentType, n.title, e.location.href), t.openPrintDialog()
                            }
                        }
                        if (window.event && (window.event.returnValue = !1), t && "function" == typeof t.preventDefault && t.preventDefault(), e && "string" == typeof e.href) {
                            var o = new Image;
                            o.onload = n, o.onerror = n, o.src = e.href
                        } else n()
                    },
                    "addthis.layers.loaded": t.once(function () {
                        var e, n, o, i, r, s, l = this.basename,
                            c = a.active_layers.addthis || {},
                            d = c.share || {},
                            u = c.follow || {};
                        t.bindEvents.call(this, {
                            '!input[type="text"],textarea,select focus': function (e, n) {
                                t.mobile() && t.hasClass("addthis-smartlayers", this.container) && (this.container.contains(n) || t.addClass(a.hideClass, this.container))
                            },
                            '!input[type="text"],textarea,select blur': function (e, n) {
                                t.mobile() && t.hasClass("addthis-smartlayers", this.container) && (this.container.contains(n) || t.removeClass(a.hideClass, this.element))
                            }
                        }), t.mobile() || (e = d.options || {}, o = e.responsive, n = u.options || {}, r = n.responsive, "mobile" === l && (o || r) && (r && (t.bindEvents.call(this, {
                            "addthis.layers.responsive.follow.show": function () {
                                o ? (i = t.getCurrentDevice(d), "mobile" === i ? (t.addClass(a.hideClass, this.followButton), t.addClass("at4-ma1", this.dock), t.removeClass("at4-ma2", this.dock)) : t.addClass(a.hideClass, this.element)) : t.addClass(a.hideClass, this.element), !this.mobile && t.isVisible(this.menu) && t.trigger("addthis.layers.mobilemenu.hide")
                            },
                            "addthis.layers.responsive.follow.hide": function () {
                                o ? (i = t.getCurrentDevice(d), "mobile" === i ? (t.removeClass(a.hideClass, this.followButton), t.removeClass("at4-ma1", this.dock), t.addClass("at4-ma2", this.dock)) : (t.removeClass(a.hideClass, this.followButton), t.addClass(a.hideClass, this.shareButton), t.addClass("at4-ma1", this.dock), t.removeClass("at4-ma2", this.dock)), t.removeClass(a.hideClass, this.element)) : (t.removeClass(a.hideClass, this.followButton), t.removeClass(a.hideClass, this.element))
                            }
                        }), s = t.getCurrentDevice(u), "mobile" === s && t.trigger("addthis.layers.responsive.follow.hide")), o && (t.bindEvents.call(this, {
                            "addthis.layers.responsive.share.show": function () {
                                r ? (s = t.getCurrentDevice(u), "mobile" === s ? (t.addClass(a.hideClass, this.shareButton), t.addClass("at4-ma1", this.dock), t.removeClass("at4-ma2", this.dock)) : t.addClass(a.hideClass, this.element)) : t.addClass(a.hideClass, this.element), !this.mobile && t.isVisible(this.menu) && t.trigger("addthis.layers.mobilemenu.hide")
                            },
                            "addthis.layers.responsive.share.hide": function () {
                                r ? (s = t.getCurrentDevice(u), "mobile" === s ? (t.removeClass(a.hideClass, this.shareButton), t.removeClass("at4-ma1", this.dock), t.addClass("at4-ma2", this.dock)) : (t.removeClass(a.hideClass, this.shareButton), t.addClass(a.hideClass, this.followButton), t.addClass("at4-ma1", this.dock), t.removeClass("at4-ma2", this.dock)), t.removeClass(a.hideClass, this.element)) : (t.removeClass(a.hideClass, this.shareButton), t.removeClass(a.hideClass, this.element))
                            }
                        }), i = t.getCurrentDevice(d), "mobile" === i && t.trigger("addthis.layers.responsive.share.hide"))))
                    }),
                    "addthis.keydown.esc": function () {
                        !this.mobile && t.isVisible(this.menu) && t.trigger("addthis.layers.mobilemenu.hide")
                    },
                    ".at4m-fwc click": function (e, n) {
                        t.trigger("addthis.layers.mobilemenu.hide");
                        var a = t.attr(n, "svc"),
                            o = t.attr(n, "svcId"),
                            i = this.pco,
                            r = {
                        ...
                        "twitter" !== a || _ate.bro.mob || t.preventDefaultEvent(e), this.superMethod("follow", a, r, i)
                    },
                    ".at4m-shc click": function (e, n) {
                        var a = n.getAttribute("svc"),
                            o = v.addthis_share ? i(v.addthis_share) : {};
                        v.addthis_config ? i(v.addthis_config) : {};
                        o.service = a, t.trigger("addthis.layers.mobilemenu.hide"), t.trigger("addthis.menu.share", x, o), ("whatsapp" === a || "viber" === a || "sms" === a || "kakaotalk" === a) && e.preventDefault()
                    },
                    "!#at4m-services click": function (e, n) {
                        t.trigger("addthis.layers.mobilemenu.hide")
                    },
                    "#at4-searchBox keyup": t.debounce(function (t, e) {
                        ...
                        var n, a, o, i = h(this.searchBox.value.toLowerCase()),
                            s = [];
                        this.servicesInMenu = {}, n = 0 === i.indexOf(".") ? new RegExp("(?:\\s|^)" + p(i)) : new RegExp("\\b" + p(i));
                        for (a in r.map) r.map.hasOwnProperty(a) && (o = l(a), ("" === i || n.test(a) || n.test(o.toLowerCase())) && s.push(a));
                        this.menuBody.innerHTML = "";
                        for (var c = 0; c < s.length; c++) {
                            var d = s[c];
                            if (this.options.services_exclude[d] !== !0) {
                                var u = this.generateShareButton(d);
                                u && this.menuBody.appendChild(u)
                            }
                        }
                    }, 500),
                    "#at4-searchClear click": function (e, n) {
                        t.preventDefaultEvent(e), this.searchBox.value = "", this.generateShareServices(), this.superMethod("hideControl", this.searchClear)
                    },
                    "addthis.layers.mobilesharemenu.show": a.commonEventHandlers.mobile.showExpandedMenu
                },
                postEvents: function () {
                    var t = this;
                    t.shareButton = g("#at4m-sb")[0], t.followButton = g("#at4m-fb")[0]
                },
                hideDesktopScrollbar: function () {
                    this.mobile || (t.addClass("at4m-scroll-overflow", this.innerMenuBody), t.addClass("at4m-hidden-overflow", w))
                },
                showDesktopScrollbar: function () {
                    this.mobile || (t.removeClass("at4m-scroll-overflow", this.innerMenuBody), t.removeClass("at4m-hidden-overflow", w))
                },
                generateJson: function () {
                    var t = {},
                        ...
                        i = o.basename,
                        r = o.options || {},
                        s = ("mobile" === i ? r.layers.follow : r) || {},
                        l = ("mobile" === i ? r.layers.share : r) || {},
                        c = this.themes[r.buttonBarTheme] ? "." + this.themes[r.buttonBarTheme] : r.theme ? this.themes[r.theme] : "",
                        d = {},
                        p = {},
                        h = {},
                        f = {},
                        m = "/" === v.location.pathname || "" === v.location.pathname,
                        g = s.__hideOnHomepage && m,
                        b = l.__hideOnHomepage && m,
                        w = "mobile" === i ? s.services : r.followServices;
                    return r.follow === !1 || "off" === r.follow || !w || !w.length || (o.mobile && s.mobile === !1 ? 1 : 0) || (o.mobile || s.responsive !== !1 ? 0 : 1) || g || (p["a#at4m-fb"] = {
                        "i.at4m-dock-follow": {},
                        href: "#",
                        html: u("Follow", 96)
                    }, e.push(p)), r.share === !1 || "off" === r.share || !("mobile" !== i || "mobile" === i && o.enabledLayers.share) || (o.mobile && l.mobile === !1 ? 1 : 0) || (o.mobile || l.responsive !== !1 ? 0 : 1) || b || (d["a#at4m-sb"] = {
                        "i.at4m-dock-share": {},
                        href: "#",
                        html: u("Share", 91)
                    }, e.push(d)), e.length ? (t["div#at4m-dock.at4m-dock" + this.positionClass + c + ".at4-ma" + e.length] = e, f["a#at4m-dock-toggle"] = {
                        html: "Toggle Dock",
                        href: "#"
                    }, n["div.at4m-dock-toggle" + this.positionClass + c] = f, a["div#at4m-menu.at4m-menu" + c] = {
                        "div.at4m-menu-inner": [{
                            "div.at4m-menu-header": {
                                "div.at4m-menu-header-inner": {
                                    "div#at4m-menu-head": u("Share", 91),
                            ...
                            "div#at4m-menu-body": {
                                "div#at4m-scroller": [{
                                    "div.at4m-menu-search": [{
                                        input: {
                                            type: "text",
                                            placeholder: u("Find a service", 35),
                                            id: "at4-searchBox"
                                        }
                                    }, {
                                        input: {
                            ...
                            "div.at4m-menu-footer": this.generateFooter()
                        }]
                    }, h["div#at4m-mobile-container " + this.positionClass + (o.showDock === !1 ? " .at-expandedmenu-component" : "")] = [t, n, a], h) : !1
                },
                ...
                generateFollowServices: function () {
                    this.menuBody.innerHTML = "";
                    for (var t = this.basename, e = "mobile" === t ? this.options.layers.follow.services : this.options.followServices, n = 0; n < e.length; n++) {
                        var a = this.generateFollowButton(e[n]);
                        a && this.menuBody.appendChild(a)
                    }
                },
                generateShareServices: function () {
                    var t = this.menuBody.cloneNode(),
                        e = this.menuBody.parentNode;
                    this.servicesInMenu = {}, this.serviceListPos = 0, this.isSearching = !1, this.searchBox.value = "", this.services || (this.services = []);
                    var n = this.options,
                        a = this.generateShareButton;
                    this.services = this.services.concat(Object.keys(r.map).filter(function (t) {
                        return !n.services_exclude[t]
                    }).sort()), this.services.filter(function (t) {
                        return !n.services_exclude[t]
                    }).forEach(function (e) {
                        var n = a(e);
                        n && t.appendChild(n)
                    }), e && (e.removeChild(this.menuBody), e.appendChild(t)), this.menuBody = t
                },
                generateShareButton: function (t) {
                    if (!s(t) || this.servicesInMenu[t] || this.serviceBlacklist[t] || this.mobileBlacklist[t]) return null;
                    var e = l(t),
                        n = c({
                            code: t,
                            alt: e,
                    ...
                    var a = _.cloneNode(!0),
                        ...
                        i = o.childNodes[0],
                        r = o.childNodes[1];
                    return o.className = "at4m-share", o.setAttribute("svc", t), o.setAttribute("title", e), o.replaceChild(n, i), r.innerHTML = e, a
                },
                generateFollowButton: function (t) {
                    var e = t || {},
                        n = e.service,
                        a = l(n),
                        i = c(n, a, a, "32px");
                    ...
                    var r = e.id,
                        ...
                        h = p.childNodes[0],
                        f = p.childNodes[1];
                    return p.className = "at4m-fwc", p.setAttribute("svc", n), p.setAttribute("svcId", r), p.setAttribute("title", a), p.setAttribute("href", d), p.setAttribute("target", "_blank"), p.replaceChild(i, h), f.innerHTML = a, p.appendChild(o.span("&gt;").css("at4-arrow").element), "twitter" === n && (p.conf = {
                        follow: !0
                    }), u
                }
            })
        ...
        t.exports = o.addthisWidget("drawer", {
            ...
            prerender: function () {
                var t = this,
                    e = t.options,
                    n = i.themes[e.theme] || "",
                    o = "left" === this.position ? "left" : "right",
                    r = "at4-drawer-" + o,
                    c = "at-" + o,
                    d = "at4-drawer-inline",
                    u = "at4-drawer-modern-browsers",
    ...
    871: function (t, e, n) {
        ...
        var i = n(79),
            ...
            l = n(357),
            c = n(656);
        a = [n(818), n(830), n(807)], o = function (t, e, n) {
            ...
            return e.addthisWidget("follow", {
                ...
                generateElement: function () {
                    ...
                    var e, a = [],
                        o = this.options || {},
                        s = this.themes[o.theme] || "",
                        d = this.openControl.substring(1),
                        u = this.closeControl.substring(1),
                    ...
                    for (e in h)
                        if (h.hasOwnProperty(e)) {
                            ...
                            m && g && b && (f = i({
                                ...
                                alt: null,
                                title: null
                            }), _ = "rss" === m ? 0 !== g.indexOf("http") ? "http://" + g : g : "twitter" !== m ? b : "//twitter.com/" + g, a.push(l.a(l.span(l.div(l.span("Follow on " + x).css("at4-visually-hidden")), l.div(f)).css(w)).attr("svc", m).attr("svcId", g).href(_).target("_blank").css("at-follow-btn", "at-circular-element")))
                        }
            ...
            return e.addthisWidget("followtoolbox", {
                ...
                generateElement: function () {
                    var e = this.options || {},
                        ...
                        u = this.orientationClass[d],
                        p = e.iconColor || "#fff",
                        h = l.getBorderRadius(e),
                        f = l.getButtonColor(e);
                ...
                events: {
                    "a click": function (e, n) {
                        var a = t.attr(n, "data-svc"),
                            o = t.attr(n, "data-svc-id"),
                            i = this.pco,
                            r = {
                                service: a,
                                id: o,
        ...
        t.exports = {
            ...
            generateShareElement: function () {
                var t = this,
                    ...
                    r = o === m.RESPONSIVE,
                    l = r ? "at-style-" + o : "",
                    d = r ? "at-resp-share-element" : "at-share-tbx-element",
                    p = r && "mobile" === a.getCurrentDevice(this) ? this.mobileClass : "",
                    h = n.size || "32px",
                    g = n.borderRadius,
                    v = u.getIconFontSize(h),
                    b = n.buttonColor,
                    w = n.iconColor || void 0,
                    x = n.hideLabel,
                    _ = "font-size:" + v + ";line-height:" + h;
                _ += ";height:" + h + ";", w && (_ += "color:" + w + ";");
                var y = "at-" + a.generateUUID();
                return this.getShareServices().forEach(function (n) {
                    var a = n.svc,
                        o = n.name,
                        i = [];
                    x || i.push(t.getLabel(o, _)), e.push(c(a, o, {
                        code: a,
                        size: h,
                        color: w,
                        backgroundColor: b,
            ...
            generateJumboCountOuterElement: function (t) {
                var e = this.getOptions(),
                    ...
                    a = e.titleFontSize,
                    o = e.counterColor,
                    i = s.span(0).css("at4-spacer").element,
                    r = a ? "font-size:" + a + ";" : "",
                    l = o ? "color:" + o + ";" : "";
            ...
            insertCount: function (t, e) {
                var n = this,
                    ...
                    r = o.style,
                    c = o.counts,
                    d = i(".at-share-btn.at-svc-" + t, this.element),
                    p = o.size,
                    h = o.iconColor || void 0,
                    g = u.getIconFontSize(p),
                    v = "font-size:" + g + ";line-height:" + p + ";";
                if (h && (v += "color:" + h + ";"), c === f.JUMBO) {
                    ...
                    var w, x = d[0];
                    r === m.RESPONSIVE ? (w = s.span(a.truncateCount(e)).css("at4-share-count-container").style(v).element, x.appendChild(w)) : r === m.FIXED && (w = s.span(a.truncateCount(e)).css("at_flat_counter").style("line-height:" + p + ";font-size:" + g).element, x.parentNode.insertBefore(w, x.nextSibling))
                }
            },
            generateThirdPartyElement: function () {
                var t = this.getOptions(),
                    e = t.originalServices || t.services || "",
                    n = e.split(","),
                    a = n.map(function (e) {
            ...
            postEvents: function () {
                ...
                if (n.thirdPartyButtons || n.style === m.ORIGINAL) {
                    ...
                    var s = n.originalServices || n.services || ""; - 1 !== s.indexOf("counter") && (t = i(".addthis_counter", e.element), t && v.counter(t[0], o, r))
                }
                return this
            }
        }
    ...
    881: function (t, e, n) {
        ...
        var i = n(79),
            ...
            c = n(357),
            d = n(813);
        a = [n(818), n(830), n(807), n(816)], o = function (t, e, n, a) {
            var o = window,
                u = o.addthis,
                p = document;
            return e.addthisWidget("share", {
                create: function () {
                    ...
                    }.bind(this) : n.commonEventHandlers.share.anticipateExpandedMenuClick, this.events = r({}, this.events, {
                        ".at-share-btn mouseover": e
                    })), this
                },
                pco: "smlsh-1.0",
                device: "desktop",
                ...
                generateElement: function () {
                    var e, a, o, r = this.getShareServices(),
                        l = this.options || {},
                        d = n.themes[l.theme] || "",
                        u = l.background,
                        p = l.iconColor,
                        h = "right" === this.position,
                        f = h ? "left" : "right",
                        m = "atss",
                        g = h ? m + "-right" : m + "-left",
                        v = !t.isIEQuirksMode() && this.showIndividualCounts(),
                        b = this.showTotalCounts(),
                        w = this.hideClass,
                        x = this.options.label || this.options.title,
                        _ = this.position.toLowerCase(),
                        y = this.openControl.substring(1),
                        k = this.closeControl.substring(1),
                        C = this,
                        M = l.textColor,
                        A = l.counterLabel || "SHARES",
                        E = l.buttonSize || "48px";
                    r.forEach(function (t) {
                        C.shownServices || (C.shownServices = []), C.shownServices.push(t.svc)
                    }), e = c.div(c.div("Show").css("at4-arrow", "at-" + f)).id(y).css("at-share-open-control", "at-share-open-control-" + _, d, "at4-hide").attr("title", "Show"), a = c.div(c.div("Hide").css("at4-arrow", "at-" + _)).id(k).css("at-share-close-control", d, w, "at4-show").attr("title", "Hide"), o = c(r, function (e) {
                        var n = e.svc,
                            a = e.name,
                            o = v && t.shareCounters.requests.services[n],
                    ...
                    var S = t.scrollBottomPercentage(),
                        z = (void 0 === this.options.scrollDepth ? -1 : this.options.scrollDepth) / 100,
                        I = z > S;
                    return c.div(c.div("AddThis Sharing Sidebar").id("at4-share-label"), c.div(x ? c.div(x).css("at4-share-title") : null, o, a).id(this.elementSelector.slice(1)).css("at4-share", "addthis_32x32_style", m, g), e).css("at4-share-outer" + (h ? "-right" : "")).css(I ? this.hideAnimation : "").css(I ? this.hideClass : "").aria("labelledby", "at4-share-label").role("region").element
                },
    ...
    885: function (t, e, n) {
        ...
        a = [n(817)], o = function (t) {
            ...
            return e.prototype.step = function () {
                ...
                if (this.listeners[t])
                    for (n = 0; n < this.listeners[t].length; n++) this.listeners[t][n].apply(this, a)
            }, e
        }.apply(e, a), !(void 0 !== o && (t.exports = o))
    },
    886: function (t, e, n) {
        ...
        t.exports = o.addthisWidget("recommended", {
            ...
            generateElement: function () {
                ...
                var t = n(356)({
                    ...
                    e = n(28).isBrandingReduced(),
                    o = t.generateBranding(e),
                    r = this.options,
                    c = r.title || "",
                    d = parseInt(r.numrows, 10) || 1,
                    u = "medium" === r.size ? "at-medium" : "",
                    p = this.inlineClass ? "at-inline" : "",
                ...
                for (var z = [], I = {}, O = 0; d > O; O++) I[".at4-recommended-container." + f] = C.slice(O * h, (O + 1) * h), z.push(l(I));
                return s.div(S, s.div(M, A, z, s.div(s.div(o).css("at4-logo-container")).css("at-logo", _), E).role("region").aria("labelledby", "at-recommended-label").id(this.elementSelector.substring(1)).css("at4-" + this.basename + "-class", "at4-recommended", g, v, w, m, b, u, p)).css("at4-" + this.basename + "-outer", x).element
            },
            imageResizing: function (t) {
                var e = this,
                    n = r(".at-recommendedTitle", e.element),
                    a = r(".at-tli", e.element);
                e.superMethod("imageResizer", n, a, t)
            },
            calcMaxRecItems: function (t, e, n) {
                var o, i, r, l, d, u = t.maxitems,
                    p = this.parentElement,
                    h = this.element.slice(1);
    ...
    890: function (t, e, n) {
        var a, o;
        n(888), a = [n(818), n(830), n(807), n(816), n(887)], o = function (t, e, n, a) {
    ...
    891: function (t, e, n) {
        ...
        var a = n(647),
            ...
            r = n(816),
            s = n(357);
        n(892), t.exports = i.addthisWidget("recommendedjumbo", {
            pco: "jrcf-1.0",
            device: "both",
            ...
            generateElement: function () {
                var t = this.element.substring(1),
            ...
            imageResizing: function (t) {
                if (this.hasFeed && this.element) {
                    var e = this,
                        n = r("#at-recommendedjumbo-content-title", e.element)[0],
                        ...
                        l = r("#at-recommendedjumbo-footer-bg", e.element)[0],
                        c = function (t) {
    ...
    897: function (t, e, n) {
        ...
        var i = n(57),
            ...
            l = n(884),
            c = n(813);
        a = [n(818), n(830), n(807), n(816), n(881)], o = function (t, e, n, a, o) {
            return e.addthisWidget("sharedock", {
                ...
                generateElement: function () {
                    var e = this.getShareServices(),
                        n = "atss",
                        a = "top" === this.position,
                        o = a ? n + "-top" : n + "-bottom",
                        d = this.options || {},
                        u = c.hasShareCounts(d),
                        p = d.buttonColor,
                        h = d.iconColor || "#FFFFFF",
                        f = d.mobileButtonSize || "large",
                        m = "at-shfs-" + f,
                        g = this.iconSizes[f],
                        v = u ? e.length + 1 : e.length,
                        b = 100 / v;
                    if (this.shareButtonElements = i(e, function (t) {
                        ...
                        var w = "width:" + b + "%;",
                            x = "";
                        p && (w += "background-color: " + p + ";", x += "color:" + h + ";"), this.label = s.span("SHARES").style(x).css("at4-share-label").element, this.counter = s.span().style(x).css("at4-counter").element, this.countElement = s.a(this.counter, this.label).style(w).href("#").title(name).css("at4-count").element, this.shareButtonElements.unshift(this.countElement)
                    }
                    var _ = u ? this.hideClass : "",
                        y = t.scrollBottomPercentage(),
                        k = (void 0 === this.options.scrollDepth ? -1 : this.options.scrollDepth) / 100,
                        C = k > y;
                    return s.div(s.div("AddThis Sharing").id("at-share-dock-label").css(this.hideClass), s.div(this.shareButtonElements).id(this.elementSelector.slice(1)).css("at-share-dock", n, o, m)).css("at-share-dock-outer", _, C ? this.hiddenClass : "").aria("labelledby", "at-share-dock-label").role("region").element
                },
    ...
    901: function (t, e, n) {
        var a, o, i = n(812),
            ...
            s = n(80),
            l = n(656);
        n(902), a = [n(818), n(830), n(807), n(816)], o = function (t, e, a, o) {
            var c = window,
                d = document;
            c.addthis;
            return e.addthisWidget("thankyou", {
                ...
                events: {
                    "addthis.menu.share": function (t, e) {
                        if (a.active_layers.addthis.share) {
                            var n = a.active_layers.addthis.follow,
                                o = n ? n.options.services : !1;
                    ...
                    ".at-follow-btn click": function (e, n) {
                        ...
                        this.superMethod("follow", a, r, i), t.trigger("addthis.thankyou.hold", addthis, {
                            action: "share/follow"
                        }), "twitter" !== a || t.mobile() || (t.preventDefaultEvent(e), t.stopEventPropagationImmediately(e))
                    }
                },
                customEvents: {},
                ...
                display: function (e, n) {
                    ...
                    var a = this.title,
                        i = this.description;
                    if (t.addClass("at-thankyou-shown", this.element), e && a && i)
                        if (t.bindEvents.call(this, this.customEvents, "remove"), "share" === e) switch (n) {
                            case "follow":
                ...
                postactionTrending: function () {
                    ...
                    var e = this,
                        n = this.superMethod("generateTrendingJson", this.pco, 4),
                        i = e.element,
                    ...
                    var n = e.map(function (e) {
                        ...
                        if (n && a && i) {
                            ...
                            return d["span.aticon-" + n] = r({
                                ...
                                alt: c,
                                title: c
                            }), d.svc = n, d.svcId = a, "rss" === n ? (d.href = 0 !== a.indexOf("http") ? "http://" + a : a, d.target = "_blank") : "twitter" !== n || t.mobile() ? (d.href = i, d.target = "_blank") : d.href = "//twitter.com/" + a, {
                                "a.aticon.at-follow-btn.at-circular-element": d
                            }
                        }
                    }).filter(function (t) {
                        return t
        ...
        t.exports = o.addthisWidget("toaster", {
            ...
            generateElement: function () {
                var t = this.options,
                    e = t.title || "",
                    a = this.maxitems || 2,
                    o = this.elementSelector.slice(1),
                    r = this.openControl.slice(1),
                    c = this.closeControl.slice(1),
                    d = "medium" === t.size ? "at-medium" : "",
                    u = this.inlineClass ? "at-inline" : "",
                    p = "at4-recommended-" + this.name,
                    h = this.options.textonly === !0 || "true" === this.options.textonly ? "at4-recommended-text-only" : "",
                    f = "at4-recommended-horizontal-logo",
                    m = i.themes[t.theme] || "",
                    ...
                    x = n(28).isBrandingReduced(),
                    _ = w.generateBranding(x),
                    y = this.trendingLinksJson = this.superMethod("generateTrendingJson", this.pco, a);
                if (!y || !y.length) return !1;
                var k = l({
                    "div.at4-recommended-container": y
                });
            ...
            postEvents: function () {
                var t = this,
                    e = r(".at-recommendedTitle", t.element),
    ...
    907: function (t, e, n) {
        ...
        var a = n(56),
            ...
            p = n(357),
            h = window.addthis;
        n(908), t.exports = c.addthisWidget("whatsnext", {
            render: function () {
                return this.queueTrending(this.options.pubid, this.options.domain, function () {
                    this.superMethod("render")
                }), this
            ...
            generateElement: function () {
                ...
                var e = this.options,
                    r = d.themes[e.theme] || "",
                    s = e.title || e.recommendedTitle,
                    l = i(t.url, {
                        pco: this.pco
                    }) || "#",
                    c = this.elementSelector.slice(1),
                    u = this.openControl.slice(1),
                    h = this.closeControl.slice(1),
                    f = n(356)({
                        campaign: "Recommended content logo"
                    }),
                    m = n(28).isBrandingReduced(),
                    g = f.generateBranding(m).css("at-branding").element,
                    v = "",
                    b = null;
            ...
            postEvents: function () {
                var t = this,
                    e = u(".at-recommendedTitle", t.element),
    ...
    910: function (t, e, n) {
        ...
        var a = n(56),
            ...
            d = n(357),
            u = window.addthis;
        n(911), t.exports = s.addthisWidget("whatsnextmobile", {
            render: function () {
                return this.queueTrending(this.options.pubid, this.options.domain, function () {
                    this.superMethod("render")
                }), this
            ...
            generateElement: function () {
                ...
                var e = this.options,
                    ...
                    u = this.elementSelector.slice(1),
                    p = this.closeControl.slice(1),
                    h = n(356)({
                        campaign: "Recommended content logo"
                    }),
                    f = n(28).isBrandingReduced(),
                    m = h.generateBranding(f).css("at-branding").element;
            ...
            postEvents: function () {
                var t = this,
                    e = c(".at-recommendedTitle", t.element);
    ...
    913: function (t, e, n) {
        ...
        a = [n(818), n(830), n(807), n(816), n(881)], o = function (t, e, n, a, o) {
            return e.addthisWidget("custommobilebar", {
                ...
                generateElement: function () {
                    var e = this.options,
                        n = "atss-" + ("top" === this.position ? "top" : "bottom"),
                        a = d.hasShareCounts(e),
                        o = e.borderRadius,
                        l = e.backgroundColor,
                        u = e.buttonColor,
                        p = e.iconColor,
                    ...
                    var x = t.scrollBottomPercentage(),
                        _ = (void 0 === this.options.scrollDepth ? -1 : this.options.scrollDepth) / 100,
                        y = _ > x;
    ...
    917: function (t, e, n) {
        ...
        a = [n(818), n(830), n(807), n(816), n(881)], o = function (t, e, n, a, o) {
            ...
            return e.addthisWidget("customsidebar", {
                ...
                generateElement: function () {
                    var e = this.options,
                        n = "atss-" + ("left" === this.position ? "left" : "right"),
                        a = this.showTotalCounts(),
                        o = e.borderRadius,
                        c = e.backgroundColor,
                        d = e.buttonColor,
                        u = e.iconColor,
    ...
    920: function (t, e, n) {
        ...
        var i = n(79),
            ...
            w = {
                "top-left-outside": b("vertical", {
                    toolWidthX: -1
                }),
                "top-left-inside": b("vertical"),
                "top-right-outside": b("vertical", {
                    imageWidthX: 1
                }),
                "top-right-inside": b("vertical", {
                    imageWidthX: 1,
                    toolWidthX: -1
                }),
                "bottom-left-inside": b("horizontal", {
                    imageHeightX: 1,
                    toolHeightX: -1
                }),
                ...
                "bottom-right-inside": b("horizontal", {
                    imageHeightX: 1,
                    toolHeightX: -1,
                    imageWidthX: 1,
                    toolWidthX: -1
        ...
        a = [n(818), n(830), n(807), n(881)], o = function (t, e, n, a) {
            return e.addthisWidget("imagesharingtool", {
                ...
                generateElement: function () {
                    ...
                    var n = e.size,
                        a = e.borderRadius,
                        o = e.buttonColor,
                        c = e.iconColor || "#ffffff",
                        u = "0%" === a ? "" : "at-custom-shape",
                        p = "at-orientation-" + w[this.position].orientation;
                    e.services || (this.services = r);
                    var h = this.getShareServices(),
                        f = d(h, function (t) {
                            var e = t.svc,
                                r = t.name,
                                s = i({
                ...
                updateToolPosition: function () {
                    ...
                    if (a) {
                        ...
                        var o = f(this.element),
                            i = e.getTopOffset(a.offsetHeight, o.height),
                ...
                validateQuerySelector: function (t, e) {
                    ...
                    var n = "img" + e.replace(/,/g, ",img"),
                        a = e.replace(/,/g, " img,") + " img",
                        o = !1;
                    try {
                        o = c(t, n) || c(t, a)
                    } catch (i) {}
                ...
                getShareAttribute: function (t, e) {
                    ...
                    if (a)
                        for (var o = 0; o < t.length; o++)
                            if (n = a.getAttribute(t[o])) return n;
    ...
    927: function (t, e) {
        "use strict";
        t.exports = function (t) {
            var e, n, a = !t.style.display || "none" === t.style.display,
                o = t.style.cssText;
    ...
    928: function (t, e, n) {
        ...
        a = [n(818), n(830), n(807), n(881)], o = function (t, e, n, a) {
            return e.addthisWidget("expandingsharebutton", {
                ...
                generateElement: function () {
                    for (var t = this.options || {}, e = t.numPreferredServices || 1, n = t.position || "bottom-right", a = t.emotion || "basic", o = t.themeColor || v, i = d(this.getShareServices(), function (t, e) {
                            return !s(e.svc)
                        }), r = this.iconAnimations, l = e; l > 0; l--) r.totalDelayMs = r.totalDelayMs + l * r.delayMs;
                    /\-left$/.test(n) && (t.showAnimation = "slideInLeft", t.hideAnimation = "slideOutLeft");
                    var c = this.getMainLabel(),
                        u = this.getToggleButton(o),
                    ...
                    var n = c(t, function (n, a) {
                        var o = n.svc,
                            ...
                            s = i({
                                ...
                                alt: r,
                                title: r,
                                backgroundColor: "default" === e ? void 0 : e
                            }),
                ...
                animateIcons: function (t) {
                    var e = this.element,
                        n = this.options.emotion || "basic",
                        a = this.options.numPreferredServices,
                        o = this.iconAnimations,
                        i = o.elements,
                        r = o.emotion[n].animateIn,
                        s = o.emotion[n].animateOut,
                        l = o.delayMs;
        ...
        e["default"] = s["default"].addthisWidget("tipjarinline", {
            ...
            generateElement: function () {
                var t = this,
                    ...
                    s = void 0 === r ? [] : r,
                    l = n.orientation,
                    d = void 0 === l ? "horizontal" : l,
                    p = n.iconColor,
                    f = void 0 === p ? "#fff" : p,
                    g = n.title,
                    b = void 0 === g ? "Want to Donate?" : g,
                    x = n.titleFontSize,
                    _ = void 0 === x ? "18px" : x,
                    y = n.titleFontColor,
                    k = void 0 === y ? "#666666" : y,
                    C = this.orientationClass[d],
                    M = w["default"].getSize(n),
                    A = w["default"].getBorderRadius(n),
                    E = w["default"].getButtonColor(n),
                    S = s.reduce(function (t, e) {
                        var n = m["default"](e);
                        if (!n) return t;
                        var a = h["default"](e.code);
                        return t.concat(c["default"](e, {
                            serviceName: a,
                            serviceEndpoint: n
                        }))
                    }, []);
                return i["default"].div(i["default"].div(i["default"].p(i["default"].span(b).style("font-size: " + _ + "; color: " + k))).css("at-tjin-title"), i["default"].div(i["default"](S, function (e) {
                    var n = e.code,
                        a = e.id,
                        o = e.serviceName,
                        r = e.serviceEndpoint,
                    ...
                    return i["default"].a(s, i["default"].span(i["default"].span("Tip with ").css("at4-visually-hidden"), o).css("addthis_tjin_label")).css("at300b", "at-tjin-btn").data("svc", n).data("svc-id", a).attr("title", "Tip with " + o).attr("href", u["default"](r, {
                        pco: t.pco
                    })).attr("target", "_blank")
    ...
    936: function (t, e, n) {
        var a, o;
        a = [n(818), n(830), n(807), n(816), n(836)], o = function (t, e, n, a, o) {
            return e.addthisComponent("mobilesharemenu", {
                inheritsFrom: "mobile",
                showDock: !1
            })
        }.apply(e, a), !(void 0 !== o && (t.exports = o))
